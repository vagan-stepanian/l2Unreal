class br_u_aga_tau_b_simple extends Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter298
         ...
         ColorScale(2)=(RelativeTime=0.542857,Color=(B=149,G=149,R=255,A=255))
         ColorScale(3)=(RelativeTime=0.778571,Color=(B=192,G=128,R=255,A=255))
     ...
     End Object
     Emitters(0)=SpriteEmitter'LineageEffect_Br.br_u_aga_tau_b_simple.SpriteEmitter298'
     Begin Object Class=MeshEmitter Name=MeshEmitter183
         ...
         Name="MeshEmitter183"
     End Object
     Emitters(1)=MeshEmitter'LineageEffect_Br.br_u_aga_tau_b_simple.MeshEmitter183'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter311
         UseDirectionAs=PTDU_Normal
         ProjectionNormal=(X=1.000000,Z=0.000000)
         UseColorScale=True
         ColorScale(0)=(Color=(B=192,G=128,R=255,A=255))
         ColorScale(1)=(RelativeTime=0.535714,Color=(B=255,G=193,R=255,A=255))
     ...
     End Object
     Emitters(2)=SpriteEmitter'LineageEffect_Br.br_u_aga_tau_b_simple.SpriteEmitter311'
     ...
     End Object
     Emitters(3)=SpriteEmitter'LineageEffect_Br.br_u_aga_tau_b_simple.SpriteEmitter326'
     AutoDestroy=False
     bNoDelete=False
}
