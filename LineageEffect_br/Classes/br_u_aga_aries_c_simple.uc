class br_u_aga_aries_c_simple extends Emitter;

defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter1117
         UseDirectionAs=PTDU_Normal
         ProjectionNormal=(X=1.000000,Z=0.000000)
         UseColorScale=True
         ColorScale(0)=(Color=(B=85,G=85,R=255,A=255))
         ColorScale(1)=(RelativeTime=0.242857,Color=(B=17,G=95,R=255,A=255))
         ColorScale(2)=(RelativeTime=0.496429,Color=(B=142,G=142,R=255,A=255))
         ColorScale(3)=(RelativeTime=0.728571,Color=(B=64,G=128,R=255,A=255))
         ...
         Name="SpriteEmitter1117"
     End Object
     Emitters(0)=SpriteEmitter'LineageEffect_Br.br_u_aga_aries_c_simple.SpriteEmitter1117'
     ...
     End Object
     Emitters(1)=SpriteEmitter'LineageEffect_Br.br_u_aga_aries_c_simple.SpriteEmitter1533'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter1534
         UseColorScale=True
         ...
         SubdivisionEnd=6
         LifetimeRange=(Min=2.000000,Max=2.000000)
         Name="SpriteEmitter1534"
     End Object
     Emitters(2)=SpriteEmitter'LineageEffect_Br.br_u_aga_aries_c_simple.SpriteEmitter1534'
     Begin Object Class=MeshEmitter Name=MeshEmitter592
         ...
         Name="MeshEmitter592"
     End Object
     Emitters(3)=MeshEmitter'LineageEffect_Br.br_u_aga_aries_c_simple.MeshEmitter592'
     bNoDelete=False
}
