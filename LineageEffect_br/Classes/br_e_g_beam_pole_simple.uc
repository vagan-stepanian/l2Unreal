class br_e_g_beam_pole_simple extends Emitter;
...
defaultproperties
{
     Begin Object Class=MeshEmitter Name=MeshEmitter15
         ...
         StartLocationRange=(X=(Min=12.000000,Max=20.000000))
         SpinParticles=True
         ...
         Name="MeshEmitter15"
     End Object
     Emitters(0)=MeshEmitter'LineageEffect_Br.br_e_g_beam_pole_simple.MeshEmitter15'
     Begin Object Class=MeshEmitter Name=MeshEmitter13
         ...
         MaxParticles=4
         StartLocationOffset=(X=8.000000)
         StartLocationRange=(X=(Min=-25.000000,Max=-12.000000))
         SpinParticles=True
         SpinsPerSecondRange=(X=(Max=0.500000),Y=(Max=0.500000),Z=(Max=0.500000))
         StartSpinRange=(X=(Max=1.000000),Y=(Max=1.000000),Z=(Max=1.000000))
         UseSizeScale=True
         ...
         Name="MeshEmitter13"
     End Object
     Emitters(1)=MeshEmitter'LineageEffect_Br.br_e_g_beam_pole_simple.MeshEmitter13'
     Begin Object Class=MeshEmitter Name=MeshEmitter1
         StaticMesh=StaticMesh'branch_S.g_beam_pole_m01_wp'
         RenderTwoSided=True
         ...
         Name="MeshEmitter1"
     End Object
     Emitters(2)=MeshEmitter'LineageEffect_Br.br_e_g_beam_pole_simple.MeshEmitter1'
     bLightChanged=True
     bNoDelete=False
     bSunAffect=True
}
