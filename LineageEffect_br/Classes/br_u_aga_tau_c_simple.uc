class br_u_aga_tau_c_simple extends Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter327
         ...
         ColorScale(1)=(RelativeTime=0.303571,Color=(B=65,G=109,R=228,A=255))
         ColorScale(2)=(RelativeTime=0.539286,Color=(B=176,G=176,R=255,A=255))
         ColorScale(3)=(RelativeTime=0.753571,Color=(B=23,G=99,R=255,A=255))
     ...
     End Object
     Emitters(0)=SpriteEmitter'LineageEffect_Br.br_u_aga_tau_c_simple.SpriteEmitter327'
     Begin Object Class=MeshEmitter Name=MeshEmitter184
         ...
         Name="MeshEmitter184"
     End Object
     Emitters(1)=MeshEmitter'LineageEffect_Br.br_u_aga_tau_c_simple.MeshEmitter184'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter328
         UseDirectionAs=PTDU_Normal
         ProjectionNormal=(X=1.000000,Z=0.000000)
         UseColorScale=True
         ColorScale(0)=(Color=(B=85,G=85,R=255,A=255))
         ColorScale(1)=(RelativeTime=0.310714,Color=(B=17,G=95,R=255,A=255))
     ...
     End Object
     Emitters(2)=SpriteEmitter'LineageEffect_Br.br_u_aga_tau_c_simple.SpriteEmitter328'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter329
         UseColorScale=True
         ColorScale(0)=(Color=(B=98,G=98,R=255,A=255))
         ColorScale(1)=(RelativeTime=0.517857,Color=(B=37,G=209,R=218,A=255))
     ...
     End Object
     Emitters(3)=SpriteEmitter'LineageEffect_Br.br_u_aga_tau_c_simple.SpriteEmitter329'
     AutoDestroy=False
     bNoDelete=False
}
