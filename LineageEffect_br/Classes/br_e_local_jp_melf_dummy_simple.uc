class br_e_local_jp_melf_dummy_simple extends Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter10
         ...
         ColorMultiplierRange=(X=(Max=0.500000),Y=(Max=0.500000),Z=(Min=0.500000,Max=0.800000))
         ...
         SphereRadiusRange=(Max=0.300000)
         ...
         StartSizeRange=(X=(Max=0.560000),Y=(Max=0.560000),Z=(Max=0.560000))
     ...
     End Object
     Emitters(0)=SpriteEmitter'LineageEffect_Br.br_e_local_jp_melf_dummy_simple.SpriteEmitter10'
     ...
     End Object
     Emitters(1)=SpriteEmitter'LineageEffect_Br.br_e_local_jp_melf_dummy_simple.SpriteEmitter69'
     bLightChanged=True
     bNoDelete=False
     bSunAffect=True
     DrawScale=0.050000
