class br_u_aga_aqu_c_simple extends Emitter;

defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter1390
         UseDirectionAs=PTDU_Normal
         ProjectionNormal=(X=1.000000,Z=0.000000)
         UseColorScale=True
         ColorScale(0)=(Color=(B=85,G=85,R=255,A=255))
         ColorScale(1)=(RelativeTime=0.260714,Color=(B=17,G=95,R=255,A=255))
         ColorScale(2)=(RelativeTime=0.500000,Color=(B=142,G=142,R=255,A=255))
         ColorScale(3)=(RelativeTime=0.739286,Color=(B=64,G=128,R=255,A=255))
         ...
         Name="SpriteEmitter1390"
     End Object
     Emitters(0)=SpriteEmitter'LineageEffect_Br.br_u_aga_aqu_c_simple.SpriteEmitter1390'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter1531
         UseDirectionAs=PTDU_Normal
         ProjectionNormal=(X=1.000000,Z=0.000000)
         UseColorScale=True
         ...
         WarmupTicksPerSecond=2.000000
         RelativeWarmupTime=2.000000
         Name="SpriteEmitter1531"
     End Object
     Emitters(1)=SpriteEmitter'LineageEffect_Br.br_u_aga_aqu_c_simple.SpriteEmitter1531'
     ...
     End Object
     Emitters(2)=SpriteEmitter'LineageEffect_Br.br_u_aga_aqu_c_simple.SpriteEmitter1532'
     Begin Object Class=MeshEmitter Name=MeshEmitter591
         ...
         ColorScale(2)=(RelativeTime=0.514286,Color=(B=92,G=180,R=237,A=255))
         ColorScale(3)=(RelativeTime=0.650000,Color=(B=77,G=138,R=230,A=255))
         ...
         Name="MeshEmitter591"
     End Object
     Emitters(3)=MeshEmitter'LineageEffect_Br.br_u_aga_aqu_c_simple.MeshEmitter591'
     bNoDelete=False
}
