class br_e_aga_mazu_skill_simple extends Emitter;
...
defaultproperties
{
     Begin Object Class=MeshEmitter Name=MeshEmitter1
         ...
         Name="MeshEmitter1"
     End Object
     Emitters(0)=MeshEmitter'LineageEffect_Br.br_e_aga_mazu_skill_simple.MeshEmitter1'
     ...
     End Object
     Emitters(1)=SpriteEmitter'LineageEffect_Br.br_e_aga_mazu_skill_simple.SpriteEmitter12'
     bNoDelete=False
     Rotation=(Pitch=-1068,Yaw=-5540,Roll=592)
     SwayRotationOrig=(Pitch=-1068,Yaw=-5540,Roll=592)
}
