class br_e_u043_aga_luckyboy_bip_simple extends Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter6
         ...
         ColorMultiplierRange=(X=(Min=0.500000,Max=1.000000),Y=(Max=0.600000),Z=(Max=0.800000))
         FadeOutStartTime=0.201500
         FadeOut=True
         CoordinateSystem=PTCS_Spray
         MaxParticles=50
         StartLocationOffset=(Z=2.000000)
         StartLocationRange=(X=(Min=-0.669000,Max=0.669000),Y=(Min=-0.669000,Max=0.669000),Z=(Min=-0.945000,Max=0.669000))
         ...
         StartSizeRange=(X=(Min=0.236250,Max=0.315000),Y=(Min=0.236250,Max=0.315000),Z=(Min=0.236250,Max=0.315000))
         ...
         StartVelocityRange=(Z=(Min=-0.315000,Max=0.315000))
         Name="SpriteEmitter6"
     End Object
     Emitters(0)=SpriteEmitter'LineageEffect.br_e_u043_aga_luckyboy_bip_simple.SpriteEmitter6'
