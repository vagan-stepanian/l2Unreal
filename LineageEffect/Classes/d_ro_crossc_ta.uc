class d_ro_crossc_ta extends Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter20
         ...
         ColorMultiplierRange=(X=(Min=0.722000,Max=1.000000),Y=(Min=1.000000,Max=1.000000),Z=(Min=0.489000,Max=0.489000))
         Opacity=0.500000
         ...
         StartVelocityRange=(X=(Min=50.000000,Max=200.000000),Y=(Min=-70.000000,Max=70.000000),Z=(Min=-70.000000,Max=70.000000))
     ...
     End Object
     Emitters(0)=SpriteEmitter'LineageEffect.d_ro_crossc_ta.SpriteEmitter20'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter39
         ...
         StartSizeRange=(X=(Min=1.000000,Max=1.000000),Y=(Min=15.000000,Max=30.000000),Z=(Min=1.000000,Max=1.000000))
     ...
     End Object
     Emitters(1)=SpriteEmitter'LineageEffect.d_ro_crossc_ta.SpriteEmitter39'
     Begin Object Class=MeshEmitter Name=MeshEmitter23
         ...
         Name="MeshEmitter23"
     End Object
     Emitters(2)=MeshEmitter'LineageEffect.d_ro_crossc_ta.MeshEmitter23'
     Begin Object Class=MeshEmitter Name=MeshEmitter15
         StaticMesh=StaticMesh'LineageEffectsStaticmeshes2.miyun.cross_01'
         UseMeshBlendMode=False
         RenderTwoSided=True
         UseColorScale=True
         ColorScale(0)=(Color=(B=250,G=163,R=137,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=24,G=19,R=236,A=255))
         ...
         StartSizeRange=(X=(Min=0.800000,Max=0.800000),Y=(Min=0.400000,Max=0.800000),Z=(Min=0.400000,Max=0.800000))
         InitialParticlesPerSecond=100.000000
         AutomaticInitialSpawning=False
         ...
         Name="MeshEmitter15"
     End Object
     Emitters(3)=MeshEmitter'LineageEffect.d_ro_crossc_ta.MeshEmitter15'
     ...
     End Object
     Emitters(4)=SpriteEmitter'LineageEffect.d_ro_crossc_ta.SpriteEmitter17'
     bNoDelete=False
     bSunAffect=True
     DrawScale=0.200000
     bDirectional=True
