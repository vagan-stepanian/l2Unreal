class u_wa_cry_orge_simple extends Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter25
         ...
         ColorMultiplierRange=(X=(Min=0.400000,Max=0.500000),Y=(Min=1.000000,Max=1.000000),Z=(Min=0.200000,Max=0.500000))
         Opacity=0.200000
     ...
     End Object
     Emitters(0)=SpriteEmitter'LineageEffect.u_wa_cry_orge_simple.SpriteEmitter25'
     ...
     End Object
     Emitters(1)=SpriteEmitter'LineageEffect.u_wa_cry_orge_simple.SpriteEmitter26'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter27
         ...
         ColorMultiplierRange=(X=(Min=0.400000,Max=0.500000),Y=(Min=1.000000,Max=1.000000),Z=(Min=0.300000,Max=0.400000))
         Opacity=0.300000
     ...
     End Object
     Emitters(2)=SpriteEmitter'LineageEffect.u_wa_cry_orge_simple.SpriteEmitter27'
     ...
     End Object
     Emitters(3)=SpriteEmitter'LineageEffect.u_wa_cry_orge_simple.SpriteEmitter28'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter29
         ColorScale(0)=(Color=(B=255,G=255,R=255,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=255,G=255,R=255,A=255))
         ColorMultiplierRange=(X=(Min=0.400000,Max=0.600000),Y=(Min=1.000000,Max=1.000000),Z=(Min=0.300000,Max=0.500000))
         Opacity=0.200000
         FadeOutStartTime=0.200000
         FadeOut=True
         FadeInEndTime=0.100000
     ...
     End Object
     Emitters(4)=SpriteEmitter'LineageEffect.u_wa_cry_orge_simple.SpriteEmitter29'
     ...
     End Object
     Emitters(5)=SpriteEmitter'LineageEffect.u_wa_cry_orge_simple.SpriteEmitter46'
     bLightChanged=True
     bNoDelete=False
     bSunAffect=True
     DrawScale=0.200000
