class d_mon_debuff_deco_simple extends Emitter;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'LineageEffect.d_mon_debuff_deco_simple.SpriteEmitter57'
     ...
     End Object
     Emitters(1)=SpriteEmitter'LineageEffect.d_mon_debuff_deco_simple.SpriteEmitter58'
     Begin Object Class=MeshEmitter Name=MeshEmitter15
         ...
         UseColorScale=True
         ColorScale(0)=(Color=(B=255,G=255,R=255,A=255))
         ColorScale(1)=(RelativeTime=0.132143,Color=(B=83,G=83,R=255,A=255))
         ColorScale(2)=(RelativeTime=0.189286,Color=(A=255))
         ColorScale(3)=(RelativeTime=0.789286,Color=(A=255))
         ColorScale(4)=(RelativeTime=0.932143,Color=(B=255,G=255,R=255,A=255))
         ColorScale(5)=(RelativeTime=1.000000,Color=(B=83,G=83,R=255,A=255))
         ...
         Name="MeshEmitter15"
     End Object
     Emitters(2)=MeshEmitter'LineageEffect.d_mon_debuff_deco_simple.MeshEmitter15'
     Begin Object Class=MeshEmitter Name=MeshEmitter16
         ...
         ColorScale(2)=(RelativeTime=0.189286,Color=(A=255))
         ColorScale(3)=(RelativeTime=0.789286,Color=(A=255))
         ColorScale(4)=(RelativeTime=0.907143,Color=(B=255,G=255,R=255,A=255))
         ...
         Name="MeshEmitter16"
     End Object
     Emitters(3)=MeshEmitter'LineageEffect.d_mon_debuff_deco_simple.MeshEmitter16'
     Begin Object Class=MeshEmitter Name=MeshEmitter17
         ...
         Name="MeshEmitter17"
     End Object
     Emitters(4)=MeshEmitter'LineageEffect.d_mon_debuff_deco_simple.MeshEmitter17'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter59
         UseColorScale=True
         ColorScale(0)=(Color=(B=255,G=255,R=255,A=255))
         ColorScale(1)=(RelativeTime=0.521429,Color=(G=82,R=251,A=255))
         ColorScale(2)=(RelativeTime=1.000000,Color=(B=255,G=255,R=255,A=255))
         ...
         StartLocationPolarRange=(X=(Min=-170.000000,Max=170.000000),Y=(Min=50.000000,Max=130.000000),Z=(Min=10.000000,Max=20.000000))
         UniformSize=True
     ...
     End Object
     Emitters(5)=SpriteEmitter'LineageEffect.d_mon_debuff_deco_simple.SpriteEmitter59'
     Begin Object Class=MeshEmitter Name=MeshEmitter18
         ...
         Name="MeshEmitter18"
     End Object
     Emitters(6)=MeshEmitter'LineageEffect.d_mon_debuff_deco_simple.MeshEmitter18'
     Begin Object Class=MeshEmitter Name=MeshEmitter19
         StaticMesh=StaticMesh'LineageEffectsStaticmeshes.etc.defense2'
         UseMeshBlendMode=False
         RenderTwoSided=True
         UseColorScale=True
         ColorScale(0)=(Color=(B=55,G=162,R=55,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=64,G=128,R=255,A=255))
         ColorMultiplierRange=(X=(Min=0.400000,Max=0.400000),Y=(Min=0.800000,Max=0.800000),Z=(Min=0.700000,Max=0.700000))
         Opacity=0.200000
         ...
         Name="MeshEmitter19"
     End Object
     Emitters(7)=MeshEmitter'LineageEffect.d_mon_debuff_deco_simple.MeshEmitter19'
     bNoDelete=False
}
