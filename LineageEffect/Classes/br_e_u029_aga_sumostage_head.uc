class br_e_u029_aga_sumostage_head extends Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter59
         ...
         StartLocationOffset=(X=0.700000,Z=0.400000)
     ...
     End Object
     Emitters(0)=SpriteEmitter'LineageEffect.br_e_u029_aga_sumostage_head.SpriteEmitter59'
     bNoDelete=False
     bSunAffect=True
     Rotation=(Pitch=16160)
     DrawScale=0.050000
}
