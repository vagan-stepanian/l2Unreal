class d_su_trade_ta extends Emitter;
...
defaultproperties
{
     Begin Object Class=MeshEmitter Name=MeshEmitter36
         ...
         StartSizeRange=(X=(Min=3.730000,Max=3.730000),Y=(Min=0.289000,Max=0.289000),Z=(Min=0.289000,Max=0.289000))
         ...
         Name="MeshEmitter36"
     End Object
     Emitters(0)=MeshEmitter'LineageEffect.d_su_trade_ta.MeshEmitter36'
     Begin Object Class=MeshEmitter Name=MeshEmitter38
         ...
         UseColorScale=True
         ColorScale(0)=(Color=(B=255,G=255,R=255,A=255))
         ColorScale(1)=(RelativeTime=0.446429,Color=(B=255,G=107,R=91,A=255))
         ColorScale(2)=(RelativeTime=1.000000,Color=(B=224,G=17,R=12,A=255))
         Opacity=0.200000
         ...
         Name="MeshEmitter38"
     End Object
     Emitters(1)=MeshEmitter'LineageEffect.d_su_trade_ta.MeshEmitter38'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter29
         ...
         StartVelocityRange=(X=(Min=-0.020000,Max=0.020000),Y=(Min=-0.020000,Max=0.020000),Z=(Min=0.073000,Max=0.073000))
         Name="SpriteEmitter29"
     End Object
     Emitters(2)=SpriteEmitter'LineageEffect.d_su_trade_ta.SpriteEmitter29'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter37
         ...
         StartSizeRange=(X=(Min=1.500000,Max=1.500000),Y=(Min=60.000000,Max=60.000000),Z=(Min=1.500000,Max=1.500000))
         InitialParticlesPerSecond=1000.000000
         AutomaticInitialSpawning=False
     ...
     End Object
     Emitters(3)=SpriteEmitter'LineageEffect.d_su_trade_ta.SpriteEmitter37'
     Begin Object Class=MeshEmitter Name=MeshEmitter33
         ...
         Name="MeshEmitter33"
     End Object
     Emitters(4)=MeshEmitter'LineageEffect.d_su_trade_ta.MeshEmitter33'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter17
         ColorScale(0)=(Color=(B=64,G=128,R=255,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=192,G=128,R=128,A=255))
         ColorMultiplierRange=(X=(Min=0.480000,Max=0.620000),Y=(Min=0.757000,Max=0.757000),Z=(Min=1.000000,Max=1.000000))
         Opacity=0.300000
         FadeOutStartTime=0.205800
         FadeOut=True
         FadeInEndTime=0.107800
         FadeIn=True
         WeatherSoundCheck=True
         IsRepresentativeParticle=False
         RespawnDeadParticles=False
         ...
         SubdivisionEnd=8
         LifetimeRange=(Min=0.299000,Max=0.495000)
     ...
     End Object
     Emitters(5)=SpriteEmitter'LineageEffect.d_su_trade_ta.SpriteEmitter17'
     bLightChanged=True
     bNoDelete=False
     DrawScale=0.200000
}
