class s_u214_ca_simple extends Emitter;
...
defaultproperties
{
     Begin Object Class=MeshEmitter Name=MeshEmitter16
         ...
         Name="MeshEmitter16"
     End Object
     Emitters(0)=MeshEmitter'LineageEffect.s_u214_ca_simple.MeshEmitter16'
     Begin Object Class=MeshEmitter Name=MeshEmitter17
         StaticMesh=StaticMesh'LineageEffectsStaticmeshes.Skill.turnundead'
         UseMeshBlendMode=False
         RenderTwoSided=True
         UseColorScale=True
         ...
         StartSizeRange=(X=(Min=0.872000,Max=0.872000),Y=(Min=0.872000,Max=0.872000),Z=(Min=0.872000,Max=0.872000))
         InitialParticlesPerSecond=1000.000000
         AutomaticInitialSpawning=False
         DrawStyle=PTDS_Brighten
         Name="MeshEmitter17"
     End Object
     Emitters(1)=MeshEmitter'LineageEffect.s_u214_ca_simple.MeshEmitter17'
     Begin Object Class=MeshEmitter Name=MeshEmitter18
         ...
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=255,G=255,R=255,A=255))
         ColorScaleRepeats=200.000000
         ColorMultiplierRange=(X=(Min=0.680000,Max=0.680000),Y=(Min=0.470000,Max=0.470000),Z=(Min=0.415000,Max=0.415000))
         Opacity=0.850000
         ...
         ForcedFade=True
         RespawnDeadParticles=False
         StartLocationOffset=(Z=1.640000)
         SpinParticles=True
         SpinCCWorCW=(X=1.000000,Y=0.000000,Z=0.000000)
         SpinsPerSecondRange=(X=(Min=0.020000,Max=0.020000))
         UseSizeScale=True
         ...
         SizeScaleRepeats=3.000000
         StartSizeRange=(X=(Min=1.654000,Max=1.654000),Y=(Min=1.654000,Max=1.654000),Z=(Min=1.654000,Max=1.654000))
         InitialParticlesPerSecond=1000.000000
         AutomaticInitialSpawning=False
         DrawStyle=PTDS_Brighten
         Name="MeshEmitter18"
     End Object
     Emitters(2)=MeshEmitter'LineageEffect.s_u214_ca_simple.MeshEmitter18'
     Begin Object Class=MeshEmitter Name=MeshEmitter19
         ...
         SizeScale(4)=(RelativeTime=1.000000,RelativeSize=1.000000)
         SizeScaleRepeats=3.000000
         StartSizeRange=(X=(Min=1.000000,Max=1.400000),Y=(Min=1.000000,Max=1.400000),Z=(Min=1.515000,Max=2.000000))
         InitialParticlesPerSecond=1000.000000
         AutomaticInitialSpawning=False
         Name="MeshEmitter19"
     End Object
     Emitters(3)=MeshEmitter'LineageEffect.s_u214_ca_simple.MeshEmitter19'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter3
         ...
         Name="SpriteEmitter3"
     End Object
     Emitters(4)=SpriteEmitter'LineageEffect.s_u214_ca_simple.SpriteEmitter3'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter65
         ...
         StartSizeRange=(X=(Min=10.000000,Max=10.000000),Y=(Min=15.000000,Max=30.000000),Z=(Min=10.000000,Max=10.000000))
         InitialParticlesPerSecond=20.000000
         AutomaticInitialSpawning=False
     ...
     End Object
     Emitters(5)=SpriteEmitter'LineageEffect.s_u214_ca_simple.SpriteEmitter65'
     bNoDelete=False
}
