class weapon_shadow_slasher_simple extends Emitter;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'LineageEffect.weapon_shadow_slasher_simple.SpriteEmitter27'
     Begin Object Class=MeshEmitter Name=MeshEmitter103
         ...
         Name="MeshEmitter103"
     End Object
     Emitters(1)=MeshEmitter'LineageEffect.weapon_shadow_slasher_simple.MeshEmitter103'
     Begin Object Class=MeshEmitter Name=MeshEmitter104
         ...
         FadeIn=True
         MaxParticles=16
         StartLocationRange=(X=(Min=-1.600000,Max=1.600000),Y=(Min=-1.600000,Max=1.600000),Z=(Min=5.000000,Max=25.000000))
         SpinParticles=True
         ...
         SizeScale(2)=(RelativeTime=1.000000,RelativeSize=1.200000)
         StartSizeRange=(X=(Min=0.100000,Max=0.150000),Y=(Min=0.100000,Max=0.150000),Z=(Min=0.150000,Max=0.300000))
         ...
         Name="MeshEmitter104"
     End Object
     Emitters(2)=MeshEmitter'LineageEffect.weapon_shadow_slasher_simple.MeshEmitter104'
     Begin Object Class=MeshEmitter Name=MeshEmitter105
         ...
         StartSizeRange=(X=(Min=0.100000,Max=0.150000),Y=(Min=0.100000,Max=0.150000),Z=(Min=0.450000,Max=0.750000))
         ...
         Name="MeshEmitter105"
     End Object
     Emitters(3)=MeshEmitter'LineageEffect.weapon_shadow_slasher_simple.MeshEmitter105'
     Begin Object Class=MeshEmitter Name=MeshEmitter106
         ...
         FadeInEndTime=0.400000
         FadeIn=True
         StartLocationRange=(X=(Min=-1.400000,Max=1.400000),Y=(Min=-1.400000,Max=1.400000),Z=(Min=5.000000,Max=25.000000))
         SpinParticles=True
         SpinCCWorCW=(X=0.000000)
         SpinsPerSecondRange=(X=(Min=0.100000,Max=0.100000))
         StartSpinRange=(X=(Min=-1.000000,Max=1.000000),Y=(Min=-0.100000,Max=0.100000),Z=(Min=-0.100000,Max=0.100000))
         ...
         StartSizeRange=(X=(Min=0.100000,Max=0.150000),Y=(Min=0.100000,Max=0.150000),Z=(Min=0.200000,Max=0.300000))
         ...
         Name="MeshEmitter106"
     End Object
     Emitters(4)=MeshEmitter'LineageEffect.weapon_shadow_slasher_simple.MeshEmitter106'
     Begin Object Class=MeshEmitter Name=MeshEmitter107
         ...
         FadeInEndTime=0.400000
         FadeIn=True
         StartLocationRange=(X=(Min=-1.800000,Max=1.800000),Y=(Min=-1.800000,Max=1.800000),Z=(Min=5.000000,Max=25.000000))
         SpinParticles=True
         SpinCCWorCW=(X=0.000000)
         SpinsPerSecondRange=(X=(Min=0.100000,Max=0.100000))
         StartSpinRange=(X=(Min=-1.000000,Max=1.000000),Y=(Min=-0.100000,Max=0.100000),Z=(Min=-0.100000,Max=0.100000))
         ...
         SizeScale(2)=(RelativeTime=1.000000,RelativeSize=1.500000)
         StartSizeRange=(X=(Min=0.150000,Max=0.150000),Y=(Min=0.150000,Max=0.150000),Z=(Min=0.200000,Max=0.300000))
         InitialParticlesPerSecond=5.000000
         AutomaticInitialSpawning=False
         DrawStyle=PTDS_Darken
         CustomMaterials(0)=Texture'LineageEffectsTextures.Particles2.fx_m_t_3216'
         ...
         Name="MeshEmitter107"
     End Object
     Emitters(5)=MeshEmitter'LineageEffect.weapon_shadow_slasher_simple.MeshEmitter107'
     ...
     End Object
     Emitters(6)=SpriteEmitter'LineageEffect.weapon_shadow_slasher_simple.SpriteEmitter28'
     ...
     End Object
     Emitters(7)=SpriteEmitter'LineageEffect.weapon_shadow_slasher_simple.SpriteEmitter31'
     Begin Object Class=MeshEmitter Name=MeshEmitter108
         ...
         FadeIn=True
         MaxParticles=4
         StartLocationOffset=(Z=6.500000)
         ...
         StartSizeRange=(X=(Min=1.000000,Max=1.350000),Y=(Min=1.000000,Max=1.350000),Z=(Min=1.000000,Max=1.350000))
         ...
         Name="MeshEmitter108"
     End Object
     Emitters(8)=MeshEmitter'LineageEffect.weapon_shadow_slasher_simple.MeshEmitter108'
     bLightChanged=True
     bNoDelete=False
     bSunAffect=True
     DrawScale=0.100000
