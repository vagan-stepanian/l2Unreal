class z_xel_hammer_ca extends Emitter;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=VertMeshEmitter'LineageEffect.z_xel_hammer_ca.VertMeshEmitter10'
     ...
     End Object
     Emitters(1)=VertMeshEmitter'LineageEffect.z_xel_hammer_ca.VertMeshEmitter12'
     bLightChanged=True
     bNoDelete=False
     bSunAffect=True
     DrawScale=0.100000
