class br_e_u028_aga_sumo_head extends Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter59
         ...
         StartLocationOffset=(X=1.500000,Z=0.700000)
         ...
         UniformSize=True
         SizeScale(0)=(RelativeTime=0.050000,RelativeSize=0.500000)
     ...
     End Object
     Emitters(0)=SpriteEmitter'LineageEffect.br_e_u028_aga_sumo_head.SpriteEmitter59'
     bNoDelete=False
     bSunAffect=True
     Rotation=(Pitch=14592,Yaw=32768,Roll=32768)
     DrawScale=0.050000
}
