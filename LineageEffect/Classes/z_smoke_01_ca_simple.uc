class z_smoke_01_ca_simple extends Emitter;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'LineageEffect.z_smoke_01_ca_simple.SpriteEmitter19'
     bNoDelete=False
     bSunAffect=True
     Rotation=(Yaw=-64979)
     CollisionRadius=540.566406
     CollisionHeight=382.238159
     bCollideActors=True
