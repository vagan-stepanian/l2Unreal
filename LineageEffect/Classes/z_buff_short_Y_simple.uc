class z_buff_short_Y_simple extends Emitter;
...
defaultproperties
{
     Begin Object Class=MeshEmitter Name=MeshEmitter19
         ...
         Name="MeshEmitter19"
     End Object
     Emitters(0)=MeshEmitter'LineageEffect.z_buff_short_Y_simple.MeshEmitter19'
     ...
     End Object
     Emitters(1)=SpriteEmitter'LineageEffect.z_buff_short_Y_simple.SpriteEmitter12'
     Begin Object Class=VertMeshEmitter Name=VertMeshEmitter11
         VertexMesh=VertMesh'LineageEffectMeshes.sMotion'
         UseMeshBlendMode=False
         UseColorScale=True
         ColorScale(0)=(Color=(B=255,G=255,R=255,A=255))
         ColorScale(1)=(RelativeTime=0.507143,Color=(G=255,R=255,A=255))
     ...
     End Object
     Emitters(2)=VertMeshEmitter'LineageEffect.z_buff_short_Y_simple.VertMeshEmitter11'
     AutoReplay=True
     bLightChanged=True
     bNoDelete=False
     bSunAffect=True
