class s_u513_b_simple extends Emitter; // 크러쉬아머 - 손, 힛타임때, self
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'LineageEffect.s_u513_b_simple.SpriteEmitter21'
     ...
     End Object
     Emitters(1)=SpriteEmitter'LineageEffect.s_u513_b_simple.SpriteEmitter22'
     bNoDelete=False
     bDirectional=True
}
