class w_machine_seed_deco_d extends Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter154
         ...
         FadeIn=True
         MaxParticles=75
         StartLocationRange=(X=(Min=-140.000000,Max=100.000000),Y=(Min=-140.000000,Max=140.000000))
         SpinParticles=True
         ...
         StartSizeRange=(X=(Min=50.000000,Max=80.000000),Y=(Min=25.000000,Max=50.000000),Z=(Min=50.000000,Max=80.000000))
     ...
     End Object
     Emitters(0)=SpriteEmitter'LineageEffect.w_machine_seed_deco_d.SpriteEmitter154'
     bLightChanged=True
     bNoDelete=False
     bSunAffect=True
     bDirectional=True
