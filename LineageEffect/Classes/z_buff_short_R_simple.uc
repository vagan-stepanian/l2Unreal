class z_buff_short_R_simple extends Emitter;
...
defaultproperties
{
     Begin Object Class=MeshEmitter Name=MeshEmitter22
         ...
         Name="MeshEmitter22"
     End Object
     Emitters(0)=MeshEmitter'LineageEffect.z_buff_short_R_simple.MeshEmitter22'
     ...
     End Object
     Emitters(1)=SpriteEmitter'LineageEffect.z_buff_short_R_simple.SpriteEmitter15'
     Begin Object Class=VertMeshEmitter Name=VertMeshEmitter13
         VertexMesh=VertMesh'LineageEffectMeshes.sMotion'
         UseMeshBlendMode=False
         UseColorScale=True
         ColorScale(0)=(Color=(B=255,G=255,R=255,A=255))
         ColorScale(1)=(RelativeTime=0.507143,Color=(B=128,R=255,A=255))
     ...
     End Object
     Emitters(2)=VertMeshEmitter'LineageEffect.z_buff_short_R_simple.VertMeshEmitter13'
     AutoReplay=True
     bLightChanged=True
     bNoDelete=False
     bSunAffect=True
