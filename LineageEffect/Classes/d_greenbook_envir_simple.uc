class d_greenbook_envir_simple extends Emitter;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'LineageEffect.d_greenbook_envir_simple.SpriteEmitter77'
     ...
     End Object
     Emitters(1)=VertMeshEmitter'LineageEffect.d_greenbook_envir_simple.VertMeshEmitter4'
     Begin Object Class=MeshEmitter Name=MeshEmitter20
         ...
         Name="MeshEmitter20"
     End Object
     Emitters(2)=MeshEmitter'LineageEffect.d_greenbook_envir_simple.MeshEmitter20'
     Begin Object Class=MeshEmitter Name=MeshEmitter21
         ...
         Name="MeshEmitter21"
     End Object
     Emitters(3)=MeshEmitter'LineageEffect.d_greenbook_envir_simple.MeshEmitter21'
     Begin Object Class=MeshEmitter Name=MeshEmitter22
         ...
         Name="MeshEmitter22"
     End Object
     Emitters(4)=MeshEmitter'LineageEffect.d_greenbook_envir_simple.MeshEmitter22'
     Begin Object Class=MeshEmitter Name=MeshEmitter23
         StaticMesh=StaticMesh'LineageEffectsStaticmeshes.wooh02.block_line'
         UseMeshBlendMode=False
         RenderTwoSided=True
         UseColorScale=True
         ColorScale(0)=(Color=(B=52,G=180,R=58,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=175,G=192,R=56,A=255))
         Opacity=0.260000
         ...
         Name="MeshEmitter23"
     End Object
     Emitters(5)=MeshEmitter'LineageEffect.d_greenbook_envir_simple.MeshEmitter23'
     Begin Object Class=MeshEmitter Name=MeshEmitter24
         StaticMesh=StaticMesh'FX_E_S.SSQ_altar01_02_np'
         UseMeshBlendMode=False
         ColorScale(0)=(Color=(B=255,G=255,R=255,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=255,G=255,R=255,A=255))
         ColorMultiplierRange=(X=(Min=0.400000,Max=0.400000),Y=(Min=0.700000,Max=0.700000),Z=(Min=0.600000,Max=0.600000))
         Opacity=0.370000
         ...
         Name="MeshEmitter24"
     End Object
     Emitters(6)=MeshEmitter'LineageEffect.d_greenbook_envir_simple.MeshEmitter24'
     bNoDelete=False
     DrawScale=0.500000
     bDirectional=True
}
