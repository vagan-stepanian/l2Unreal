class br_e_u031_aga_dailaon_weapon_simple extends Emitter;

defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter0
         ColorScale(0)=(Color=(R=64,A=255))
         ColorScale(1)=(RelativeTime=0.357143,Color=(R=64,A=255))
         ...
         StartSizeRange=(X=(Min=1.347500,Max=1.347500),Y=(Min=1.347500,Max=1.347500),Z=(Min=1.347500,Max=1.347500))
         ...
         Name="SpriteEmitter0"
     End Object
     Emitters(0)=SpriteEmitter'LineageEffect.br_e_u031_aga_dailaon_weapon_simple.SpriteEmitter0'
     bLightChanged=True
     bNoDelete=False
     bSunAffect=True
     DrawScale=0.100000
