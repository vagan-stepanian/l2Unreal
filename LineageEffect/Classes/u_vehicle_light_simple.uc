class u_vehicle_light_simple extends Emitter;
...
defaultproperties
{
     Begin Object Class=MeshEmitter Name=MeshEmitter11
         ...
         StartSizeRange=(X=(Min=0.300000,Max=0.300000),Y=(Min=0.750000,Max=0.750000),Z=(Min=0.300000,Max=0.300000))
         InitialParticlesPerSecond=10.000000
         AutomaticInitialSpawning=False
         LifetimeRange=(Min=1.000000,Max=1.000000)
         Name="MeshEmitter11"
     End Object
     Emitters(0)=MeshEmitter'LineageEffect.u_vehicle_light_simple.MeshEmitter11'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter38
         ...
         StartSizeRange=(X=(Min=4.000000,Max=4.000000),Y=(Min=5.000000,Max=5.000000),Z=(Min=5.000000,Max=5.000000))
         InitialParticlesPerSecond=10.000000
         AutomaticInitialSpawning=False
     ...
     End Object
     Emitters(1)=SpriteEmitter'LineageEffect.u_vehicle_light_simple.SpriteEmitter38'
     bNoDelete=False
     Rotation=(Pitch=-4276,Yaw=-2076,Roll=552)
     SwayRotationOrig=(Pitch=-4276,Yaw=-2076,Roll=552)
}
