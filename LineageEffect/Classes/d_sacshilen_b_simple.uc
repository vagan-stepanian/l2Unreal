class d_sacshilen_b_simple extends Emitter;

defaultproperties
{
     Begin Object Class=VertMeshEmitter Name=VertMeshEmitter25
         VertexMesh=VertMesh'BG_EffectMeshes.sacrifice_shilenV04'
         UseMeshBlendMode=False
         RenderTwoSided=False
         ColorScale(0)=(Color=(B=255,G=255,R=255,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=255,G=255,R=255,A=255))
         FadeOutStartTime=118.800003
         FadeOut=True
         MaxParticles=1
     ...
     End Object
     Emitters(0)=VertMeshEmitter'LineageEffect.d_sacshilen_b_simple.VertMeshEmitter25'
     Begin Object Class=MeshEmitter Name=MeshEmitter40
         ...
         Name="MeshEmitter40"
     End Object
     Emitters(1)=MeshEmitter'LineageEffect.d_sacshilen_b_simple.MeshEmitter40'
     ...
     End Object
     Emitters(2)=SpriteEmitter'LineageEffect.d_sacshilen_b_simple.SpriteEmitter193'
     ...
     End Object
     Emitters(3)=SpriteEmitter'LineageEffect.d_sacshilen_b_simple.SpriteEmitter194'
     bLightChanged=True
     bNoDelete=False
     bSunAffect=True
