class d_he_shelterr_tara extends Emitter;
...
defaultproperties
{
     Begin Object Class=MeshEmitter Name=MeshEmitter30
         ...
         Name="MeshEmitter30"
     End Object
     Emitters(0)=MeshEmitter'LineageEffect.d_he_shelterr_tara.MeshEmitter30'
     Begin Object Class=VertMeshEmitter Name=VertMeshEmitter6
         VertexMesh=VertMesh'LineageEffectMeshes.sphere_shield'
         UseMeshBlendMode=False
         UseColorScale=True
         ColorScale(0)=(Color=(B=254,G=100,R=7,A=255))
     ...
     End Object
     Emitters(1)=VertMeshEmitter'LineageEffect.d_he_shelterr_tara.VertMeshEmitter6'
     Begin Object Class=MeshEmitter Name=MeshEmitter31
         StaticMesh=StaticMesh'LineageEffectsStaticmeshes2.miyun.sphere_01'
         UseMeshBlendMode=False
         RenderTwoSided=True
         UseColorScale=True
         ColorScale(0)=(Color=(B=252,G=158,R=254,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=9,G=15,R=255,A=255))
         ColorScaleRepeats=3.000000
         ...
         Name="MeshEmitter31"
     End Object
     Emitters(2)=MeshEmitter'LineageEffect.d_he_shelterr_tara.MeshEmitter31'
     Begin Object Class=MeshEmitter Name=MeshEmitter32
         ...
         Name="MeshEmitter32"
     End Object
     Emitters(3)=MeshEmitter'LineageEffect.d_he_shelterr_tara.MeshEmitter32'
     ...
     End Object
     Emitters(4)=VertMeshEmitter'LineageEffect.d_he_shelterr_tara.VertMeshEmitter7'
     bLightChanged=True
     bNoDelete=False
     bSunAffect=True
