class br_event_it_halloween_simple extends Emitter;
...
defaultproperties
{
     Begin Object Class=MeshEmitter Name=MeshEmitter56
         ...
         Opacity=0.200000
         MaxParticles=1
         StartSizeRange=(X=(Min=0.780000,Max=0.780000),Y=(Min=0.780000,Max=0.780000),Z=(Min=0.780000,Max=0.780000))
         InitialParticlesPerSecond=10.000000
         AutomaticInitialSpawning=False
         LifetimeRange=(Min=1.000000,Max=1.000000)
         Name="MeshEmitter56"
     End Object
     Emitters(0)=MeshEmitter'LineageEffect.br_event_it_halloween_simple.MeshEmitter56'
     Begin Object Class=MeshEmitter Name=MeshEmitter57
         ...
         StartSizeRange=(X=(Min=0.063504,Max=0.090720),Y=(Min=0.063504,Max=0.090720),Z=(Min=0.063504,Max=0.090720))
         InitialParticlesPerSecond=4.000000
         AutomaticInitialSpawning=False
         LifetimeRange=(Min=2.000000,Max=2.000000)
         Name="MeshEmitter57"
     End Object
     Emitters(1)=MeshEmitter'LineageEffect.br_event_it_halloween_simple.MeshEmitter57'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter61
         ...
         StartSizeRange=(X=(Min=0.305760,Max=0.382200),Y=(Min=0.305760,Max=0.382200),Z=(Min=0.305760,Max=0.382200))
         InitialParticlesPerSecond=10.000000
         AutomaticInitialSpawning=False
     ...
     End Object
     Emitters(2)=SpriteEmitter'LineageEffect.br_event_it_halloween_simple.SpriteEmitter61'
     bNoDelete=False
     bUnlit=False
}
