class glacia_trap_immortality extends Emitter;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'LineageEffect.glacia_trap_immortality.SpriteEmitter126'
     ...
     End Object
     Emitters(1)=SpriteEmitter'LineageEffect.glacia_trap_immortality.SpriteEmitter129'
     bLightChanged=True
     bNoDelete=False
     bSunAffect=True
}
