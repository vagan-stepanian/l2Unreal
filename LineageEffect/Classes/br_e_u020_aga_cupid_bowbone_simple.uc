class br_e_u020_aga_cupid_bowbone_simple extends Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter9
         ...
         FadeIn=True
         MaxParticles=1
         StartLocationOffset=(X=2.800000)
         SpinParticles=True
         ...
         Name="SpriteEmitter9"
     End Object
     Emitters(0)=SpriteEmitter'LineageEffect.br_e_u020_aga_cupid_bowbone_simple.SpriteEmitter9'
     bLightChanged=True
     bNoDelete=False
     bSunAffect=True
     DrawScale=0.100000
