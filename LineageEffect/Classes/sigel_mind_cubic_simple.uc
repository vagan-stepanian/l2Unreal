class sigel_mind_cubic_simple extends NCubics;
...
defaultproperties
{
     Begin Object Class=MeshEmitter Name=MeshEmitter20
         ...
         Name="MeshEmitter20"
     End Object
     Emitters(0)=MeshEmitter'LineageEffect.sigel_mind_cubic_simple.MeshEmitter20'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter29
         UseColorScale=True
         ColorScale(0)=(Color=(B=255,G=223,R=187,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=255,G=253,R=181,A=255))
     ...
     End Object
     Emitters(1)=SpriteEmitter'LineageEffect.sigel_mind_cubic_simple.SpriteEmitter29'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter30
         UseColorScale=True
         ColorScale(0)=(Color=(B=255,G=210,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=255,G=255,R=255,A=255))
     ...
     End Object
     Emitters(2)=SpriteEmitter'LineageEffect.sigel_mind_cubic_simple.SpriteEmitter30'
     ...
     End Object
     Emitters(3)=SpriteEmitter'LineageEffect.sigel_mind_cubic_simple.SpriteEmitter31'
     Begin Object Class=MeshEmitter Name=MeshEmitter21
         ...
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=255,G=255,R=255,A=255))
         ColorMultiplierRange=(X=(Max=0.200000),Y=(Max=0.500000),Z=(Min=0.800000,Max=1.000000))
         ...
         Name="MeshEmitter21"
     End Object
     Emitters(4)=MeshEmitter'LineageEffect.sigel_mind_cubic_simple.MeshEmitter21'
     bLightChanged=True
     bSunAffect=True
