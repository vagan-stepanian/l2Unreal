class weapon_vala_caster_simple extends Emitter;

defaultproperties
{
     Begin Object Class=MeshEmitter Name=MeshEmitter71
         StaticMesh=StaticMesh'LineageEffectsStaticmeshes2.valakas.valakas_caster'
         UseMeshBlendMode=False
         RenderTwoSided=True
         UseColorScale=True
         ColorScale(0)=(Color=(B=128,G=128,R=128,A=255))
         ColorScale(1)=(RelativeTime=0.496429,Color=(B=252,G=252,R=252,A=255))
         ...
         Name="MeshEmitter71"
     End Object
     Emitters(0)=MeshEmitter'LineageEffect.weapon_vala_caster_simple.MeshEmitter71'
     Begin Object Class=MeshEmitter Name=MeshEmitter76
         ...
         Name="MeshEmitter76"
     End Object
     Emitters(1)=MeshEmitter'LineageEffect.weapon_vala_caster_simple.MeshEmitter76'
     Begin Object Class=MeshEmitter Name=MeshEmitter78
         ...
         Name="MeshEmitter78"
     End Object
     Emitters(2)=MeshEmitter'LineageEffect.weapon_vala_caster_simple.MeshEmitter78'
     Begin Object Class=MeshEmitter Name=MeshEmitter79
         StaticMesh=StaticMesh'LineageEffectsStaticmeshes2.valakas.valakas_caster_glow'
         RenderTwoSided=True
         ...
         AutomaticInitialSpawning=False
         DrawStyle=PTDS_Brighten
         CustomMaterials(0)=Shader'LineageEffectsTextures2.Particles2.vala_caster_glow'
         LifetimeRange=(Min=2.000000,Max=2.000000)
         WarmupTicksPerSecond=1.000000
         RelativeWarmupTime=1.000000
         Name="MeshEmitter79"
     End Object
     Emitters(3)=MeshEmitter'LineageEffect.weapon_vala_caster_simple.MeshEmitter79'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter3
         UseDirectionAs=PTDU_Up
         Acceleration=(Z=5.000000)
         UseColorScale=True
         ColorScale(0)=(Color=(B=255,G=255,R=255,A=255))
         ColorScale(1)=(RelativeTime=0.217857,Color=(R=57,A=255))
         ColorScale(2)=(RelativeTime=0.503571,Color=(R=55,A=255))
         ColorScale(3)=(RelativeTime=0.682143,Color=(R=138,A=255))
         ColorScale(4)=(RelativeTime=0.785714,Color=(B=255,G=255,R=255,A=255))
         ...
         StartLocationPolarRange=(X=(Min=-90.000000,Max=90.000000),Y=(Min=-90.000000,Max=90.000000),Z=(Min=-1.000000,Max=1.000000))
         UseRevolution=True
         ...
         StartSizeRange=(X=(Min=3.000000,Max=4.000000),Y=(Min=7.000000,Max=9.000000),Z=(Min=3.000000,Max=4.000000))
         ...
         StartVelocityRange=(X=(Min=-6.000000,Max=6.000000),Y=(Min=-6.000000,Max=6.000000),Z=(Min=5.000000,Max=8.000000))
         GetVelocityDirectionFrom=PTVD_OwnerAndStartPosition
         WarmupTicksPerSecond=2.000000
         RelativeWarmupTime=2.000000
         Name="SpriteEmitter3"
     End Object
     Emitters(4)=SpriteEmitter'LineageEffect.weapon_vala_caster_simple.SpriteEmitter3'
     Begin Object Class=MeshEmitter Name=MeshEmitter80
         ...
         Name="MeshEmitter80"
     End Object
     Emitters(5)=MeshEmitter'LineageEffect.weapon_vala_caster_simple.MeshEmitter80'
     Begin Object Class=MeshEmitter Name=MeshEmitter81
         ...
         StartSizeRange=(X=(Min=0.700000,Max=0.900000),Y=(Min=0.700000,Max=0.900000),Z=(Min=0.800000,Max=1.050000))
         InitialParticlesPerSecond=3.000000
         AutomaticInitialSpawning=False
         ...
         Name="MeshEmitter81"
     End Object
     Emitters(6)=MeshEmitter'LineageEffect.weapon_vala_caster_simple.MeshEmitter81'
     Begin Object Class=MeshEmitter Name=MeshEmitter92
         ...
         Name="MeshEmitter92"
     End Object
     Emitters(7)=MeshEmitter'LineageEffect.weapon_vala_caster_simple.MeshEmitter92'
     Begin Object Class=MeshEmitter Name=MeshEmitter146
         ...
         FadeIn=True
         MaxParticles=12
         StartLocationRange=(Z=(Min=14.000000,Max=18.000000))
         SpinParticles=True
         ...
         Name="MeshEmitter146"
     End Object
     Emitters(8)=MeshEmitter'LineageEffect.weapon_vala_caster_simple.MeshEmitter146'
     bLightChanged=True
     bNoDelete=False
     bSunAffect=True
     Rotation=(Pitch=-44,Yaw=-8,Roll=65543)
     DrawScale=0.050000
     bUnlit=False
     SwayRotationOrig=(Pitch=-44,Yaw=-8,Roll=65543)
     bDirectional=True
}
