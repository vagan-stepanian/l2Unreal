class range_region_decal_darken_simple extends ProjectedEmitter;
...
defaultproperties
{
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter1
         ...
         ColorScale(1)=(RelativeTime=0.492857,Color=(B=255,G=255,A=255))
         ColorScale(2)=(RelativeTime=1.000000,Color=(B=255,G=255,R=200,A=255))
         ...
         Name="SpriteEmitter1"
     End Object
     Emitters(0)=SpriteEmitter'LineageEffect.range_region_decal_darken_simple.SpriteEmitter1'
     bLightChanged=True
     bNoDelete=False
     bSunAffect=True
}
