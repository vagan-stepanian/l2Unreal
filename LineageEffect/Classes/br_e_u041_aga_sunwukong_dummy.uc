class br_e_u041_aga_sunwukong_dummy extends Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter63
         ...
         FadeIn=True
         MaxParticles=60
         StartLocationRange=(X=(Min=-0.073440,Max=0.073440),Y=(Min=-0.365040,Max=0.365040),Z=(Min=-0.365040,Max=0.365040))
         ...
         StartSizeRange=(X=(Min=2.187000,Max=5.103000),Y=(Min=2.187000,Max=5.103000),Z=(Min=2.187000,Max=5.103000))
     ...
     End Object
     Emitters(0)=SpriteEmitter'LineageEffect.br_e_u041_aga_sunwukong_dummy.SpriteEmitter63'
     bLightChanged=True
     bNoDelete=False
     bSunAffect=True
     DrawScale=0.100000
