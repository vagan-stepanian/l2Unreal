class u_er_wa_gpower_ca_simple extends Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter39
         ...
         ColorMultiplierRange=(X=(Min=0.500000,Max=0.800000),Y=(Min=0.800000,Max=1.000000),Z=(Min=0.800000,Max=1.000000))
         Opacity=0.200000
         FadeOutStartTime=0.377000
         FadeOut=True
     ...
     End Object
     Emitters(0)=SpriteEmitter'LineageEffect.u_er_wa_gpower_ca_simple.SpriteEmitter39'
     ...
     End Object
     Emitters(1)=SpriteEmitter'LineageEffect.u_er_wa_gpower_ca_simple.SpriteEmitter40'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter41
         UseDirectionAs=PTDU_Forward
         ColorScale(0)=(Color=(B=128,G=64,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=255,G=255,R=255,A=255))
         ColorMultiplierRange=(X=(Min=1.000000,Max=1.000000),Y=(Min=0.800000,Max=0.830000),Z=(Min=0.664000,Max=0.664000))
     ...
     End Object
     Emitters(2)=SpriteEmitter'LineageEffect.u_er_wa_gpower_ca_simple.SpriteEmitter41'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter42
         UseDirectionAs=PTDU_Forward
         RefrUScale=0.080000
         RefrVScale=0.080000
         UseColorScale=True
         ColorScale(0)=(Color=(B=66,G=160,R=255,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=255,G=255,R=255,A=255))
     ...
     End Object
     Emitters(3)=SpriteEmitter'LineageEffect.u_er_wa_gpower_ca_simple.SpriteEmitter42'
     ...
     End Object
     Emitters(4)=SpriteEmitter'LineageEffect.u_er_wa_gpower_ca_simple.SpriteEmitter43'
     ...
     End Object
     Emitters(5)=SpriteEmitter'LineageEffect.u_er_wa_gpower_ca_simple.SpriteEmitter14'
     bLightChanged=True
     bNoDelete=False
     bSunAffect=True
