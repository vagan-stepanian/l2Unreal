class s_u023_long_simple extends Emitter;
...
defaultproperties
{
     Begin Object Class=BeamEmitter Name=BeamEmitter3
         ...
         Name="BeamEmitter3"
     End Object
     Emitters(0)=BeamEmitter'LineageEffect.s_u023_long_simple.BeamEmitter3'
     Begin Object Class=BeamEmitter Name=BeamEmitter6
         ...
         StartVelocityRange=(X=(Min=260.000000,Max=260.000000),Y=(Min=260.000000,Max=260.000000),Z=(Min=200.000000,Max=200.000000))
         GetVelocityDirectionFrom=PTVD_OwnerAndStartPosition
         Name="BeamEmitter6"
     End Object
     Emitters(1)=BeamEmitter'LineageEffect.s_u023_long_simple.BeamEmitter6'
     Begin Object Class=MeshEmitter Name=MeshEmitter8
         ...
         StartSizeRange=(X=(Min=0.600000,Max=1.200000),Y=(Min=0.600000,Max=1.200000),Z=(Min=0.600000,Max=1.200000))
         InitialParticlesPerSecond=30.000000
         AutomaticInitialSpawning=False
         LifetimeRange=(Min=0.600000,Max=1.200000)
         InitialDelayRange=(Min=0.100000,Max=0.100000)
         StartVelocityRange=(X=(Min=-80.000000,Max=80.000000),Y=(Min=-80.000000,Max=80.000000),Z=(Min=-160.000000,Max=160.000000))
         VelocityLossRange=(X=(Min=2.000000,Max=2.000000),Y=(Min=2.000000,Max=2.000000),Z=(Min=2.000000,Max=2.000000))
         Name="MeshEmitter8"
     End Object
     Emitters(2)=MeshEmitter'LineageEffect.s_u023_long_simple.MeshEmitter8'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter4
         ...
         Name="SpriteEmitter4"
     End Object
     Emitters(3)=SpriteEmitter'LineageEffect.s_u023_long_simple.SpriteEmitter4'
     Begin Object Class=MeshEmitter Name=MeshEmitter9
         ...
         InitialDelayRange=(Min=0.100000,Max=0.100000)
         StartVelocityRange=(X=(Min=-60.000000,Max=60.000000),Y=(Min=-60.000000,Max=60.000000),Z=(Min=-500.000000,Max=40.000000))
         VelocityLossRange=(X=(Min=3.000000,Max=3.000000),Y=(Min=3.000000,Max=3.000000),Z=(Min=1.000000,Max=1.000000))
         Name="MeshEmitter9"
     End Object
     Emitters(4)=MeshEmitter'LineageEffect.s_u023_long_simple.MeshEmitter9'
     bLightChanged=True
     bNoDelete=False
     bSunAffect=True
     DrawScale=0.150000
