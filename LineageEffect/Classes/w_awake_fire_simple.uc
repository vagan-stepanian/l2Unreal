class w_awake_fire_simple extends Emitter;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'LineageEffect.w_awake_fire_simple.SpriteEmitter60'
     ...
     End Object
     Emitters(1)=SpriteEmitter'LineageEffect.w_awake_fire_simple.SpriteEmitter63'
     ...
     End Object
     Emitters(2)=SpriteEmitter'LineageEffect.w_awake_fire_simple.SpriteEmitter64'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter65
         Acceleration=(Z=44.000000)
         ColorScale(0)=(Color=(B=255,G=255,R=255,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=255,G=255,R=255,A=255))
         ColorMultiplierRange=(X=(Min=0.700000,Max=0.700000),Y=(Min=0.400000,Max=0.400000),Z=(Min=0.700000,Max=0.700000))
         Opacity=0.500000
     ...
     End Object
     Emitters(3)=SpriteEmitter'LineageEffect.w_awake_fire_simple.SpriteEmitter65'
     bNoDelete=False
}
