class s_u808_blue_c_simple extends Emitter;

defaultproperties
{
     Begin Object Class=MeshEmitter Name=MeshEmitter10
         StaticMesh=StaticMesh'LineageEffectsStaticmeshes.etc.membrane_03_blink'
         RenderTwoSided=True
         ...
         Name="MeshEmitter10"
     End Object
     Emitters(0)=MeshEmitter'LineageEffect.s_u808_blue_c_simple.MeshEmitter10'
     bLightChanged=True
     bNoDelete=False
     bSunAffect=True
}
