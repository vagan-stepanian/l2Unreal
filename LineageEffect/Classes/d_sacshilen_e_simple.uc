class d_sacshilen_e_simple extends Emitter;

defaultproperties
{
     Begin Object Class=VertMeshEmitter Name=VertMeshEmitter15
         VertexMesh=VertMesh'BG_EffectMeshes.sacrifice_shilenV02'
         UseMeshBlendMode=False
         RenderTwoSided=False
         ColorScale(0)=(Color=(B=255,G=255,R=255,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=255,G=255,R=255,A=255))
         FadeOutStartTime=58.200001
         FadeOut=True
         MaxParticles=1
     ...
     End Object
     Emitters(0)=VertMeshEmitter'LineageEffect.d_sacshilen_e_simple.VertMeshEmitter15'
     Begin Object Class=MeshEmitter Name=MeshEmitter28
         ...
         Name="MeshEmitter28"
     End Object
     Emitters(1)=MeshEmitter'LineageEffect.d_sacshilen_e_simple.MeshEmitter28'
     ...
     End Object
     Emitters(2)=SpriteEmitter'LineageEffect.d_sacshilen_e_simple.SpriteEmitter178'
     ...
     End Object
     Emitters(3)=SpriteEmitter'LineageEffect.d_sacshilen_e_simple.SpriteEmitter179'
     bLightChanged=True
     bNoDelete=False
     bSunAffect=True
     Rotation=(Yaw=112)
