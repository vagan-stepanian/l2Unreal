class d_wa_winshout_tara extends Emitter;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'LineageEffect.d_wa_winshout_tara.SpriteEmitter36'
     ...
     End Object
     Emitters(1)=SpriteEmitter'LineageEffect.d_wa_winshout_tara.SpriteEmitter28'
     ...
     End Object
     Emitters(2)=SpriteEmitter'LineageEffect.d_wa_winshout_tara.SpriteEmitter29'
     Begin Object Class=MeshEmitter Name=MeshEmitter39
         ...
         Name="MeshEmitter39"
     End Object
     Emitters(3)=MeshEmitter'LineageEffect.d_wa_winshout_tara.MeshEmitter39'
     Begin Object Class=MeshEmitter Name=MeshEmitter14
         ...
         ColorScale(0)=(Color=(B=255,G=255,R=255,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=255,G=255,R=255,A=255))
         ColorMultiplierRange=(X=(Min=1.000000,Max=1.000000),Y=(Min=0.450000,Max=0.450000))
         Opacity=0.600000
         FadeOutStartTime=0.121500
         FadeOut=True
         FadeInEndTime=0.049500
         ...
         Name="MeshEmitter14"
     End Object
     Emitters(4)=MeshEmitter'LineageEffect.d_wa_winshout_tara.MeshEmitter14'
     bLightChanged=True
     bNoDelete=False
     bSunAffect=True
     DrawScale=0.100000
