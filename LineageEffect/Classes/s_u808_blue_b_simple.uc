class s_u808_blue_b_simple extends Emitter;

defaultproperties
{
     Begin Object Class=MeshEmitter Name=MeshEmitter8
         StaticMesh=StaticMesh'LineageEffectsStaticmeshes.etc.membrane_03'
         RenderTwoSided=True
         ...
         Name="MeshEmitter8"
     End Object
     Emitters(0)=MeshEmitter'LineageEffect.s_u808_blue_b_simple.MeshEmitter8'
     bLightChanged=True
     bNoDelete=False
     bSunAffect=True
}
