class d_shockwave_redsh_simple extends Emitter;
...
defaultproperties
{
     Begin Object Class=MeshEmitter Name=MeshEmitter13
         ...
         ColorScale(1)=(RelativeTime=0.585714,Color=(B=37,G=87,R=218,A=255))
         ColorScale(2)=(RelativeTime=1.000000,Color=(B=170,G=170,R=227,A=255))
         Opacity=0.500000
         ...
         Name="MeshEmitter13"
     End Object
     Emitters(0)=MeshEmitter'LineageEffect.d_shockwave_redsh_simple.MeshEmitter13'
     Begin Object Class=MeshEmitter Name=MeshEmitter14
         StaticMesh=StaticMesh'LineageEffectsStaticmeshes.wooh02.fx_m_sm8160'
         UseMeshBlendMode=False
         RenderTwoSided=True
         UseColorScale=True
         ColorScale(0)=(Color=(B=186,G=219,R=241,A=255))
         ColorScale(1)=(RelativeTime=0.642857,Color=(B=62,G=143,R=255,A=255))
         ColorScale(2)=(RelativeTime=0.821429,Color=(R=255,A=255))
         ColorScale(3)=(RelativeTime=1.000000,Color=(B=58,G=58,R=203,A=255))
         FadeOutStartTime=0.250000
         FadeOut=True
         ...
         Name="MeshEmitter14"
     End Object
     Emitters(1)=MeshEmitter'LineageEffect.d_shockwave_redsh_simple.MeshEmitter14'
     bLightChanged=True
     bNoDelete=False
     bSunAffect=True
     DrawScale=0.200000
