class d_ar_tan6_fl_simple extends NSkillProjectile;
...
defaultproperties
{
     ...
     Begin Object Class=MeshEmitter Name=MeshEmitter5
         ...
         RenderTwoSided=True
         UseColorScale=True
         ColorScale(0)=(Color=(B=242,G=230,R=255,A=255))
         ColorScale(1)=(RelativeTime=0.417857,Color=(B=255,G=107,R=64,A=255))
         ColorScale(2)=(RelativeTime=0.635714,Color=(B=249,G=119,R=113,A=255))
         ...
         Name="MeshEmitter5"
     End Object
     Emitters(0)=MeshEmitter'LineageEffect.d_ar_tan6_fl_simple.MeshEmitter5'
     Begin Object Class=TrailEmitter Name=TrailEmitter52
         ...
         ColorScale(1)=(RelativeTime=0.421429,Color=(B=238,G=172,R=128,A=255))
         ColorScale(2)=(RelativeTime=0.603571,Color=(B=213,G=136,R=43,A=255))
         ColorScale(3)=(RelativeTime=1.000000,Color=(B=85,G=32,R=38,A=255))
         ...
         Name="TrailEmitter52"
     End Object
     Emitters(1)=TrailEmitter'LineageEffect.d_ar_tan6_fl_simple.TrailEmitter52'
     ...
     End Object
     Emitters(2)=SpriteEmitter'LineageEffect.d_ar_tan6_fl_simple.SpriteEmitter38'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter52
         UseDirectionAs=PTDU_Normal
         ProjectionNormal=(X=1.000000,Z=0.000000)
         UseColorScale=True
         ColorScale(0)=(Color=(B=255,G=255,R=255,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=213,G=170,R=43,A=255))
     ...
     End Object
     Emitters(3)=SpriteEmitter'LineageEffect.d_ar_tan6_fl_simple.SpriteEmitter52'
     Begin Object Class=MeshEmitter Name=MeshEmitter1
         ...
         Name="MeshEmitter1"
     End Object
     Emitters(4)=MeshEmitter'LineageEffect.d_ar_tan6_fl_simple.MeshEmitter1'
     AutoReset=True
     bRotEmitter=True
     RotPerSecond=(Roll=91440)
     bLightChanged=True
     bSunAffect=True
     Rotation=(Roll=-1101558982)
     DrawScale=0.150000
     bUnlit=False
     SwayRotationOrig=(Roll=-1114889725)
     bDirectional=True
}
