class weapon_lind_caster_simple extends Emitter;
...
defaultproperties
{
     Begin Object Class=MeshEmitter Name=MeshEmitter196
         ...
         Name="MeshEmitter196"
     End Object
     Emitters(0)=MeshEmitter'LineageEffect.weapon_lind_caster_simple.MeshEmitter196'
     Begin Object Class=MeshEmitter Name=MeshEmitter197
         ...
         Name="MeshEmitter197"
     End Object
     Emitters(1)=MeshEmitter'LineageEffect.weapon_lind_caster_simple.MeshEmitter197'
     Begin Object Class=MeshEmitter Name=MeshEmitter198
         ...
         StartSizeRange=(X=(Min=0.332000,Max=0.406000),Y=(Min=0.332000,Max=0.406000),Z=(Min=0.332000,Max=0.406000))
         ...
         Name="MeshEmitter198"
     End Object
     Emitters(2)=MeshEmitter'LineageEffect.weapon_lind_caster_simple.MeshEmitter198'
     Begin Object Class=MeshEmitter Name=MeshEmitter199
         StaticMesh=StaticMesh'LineageEffectsStaticmeshes2.Weapon.Lind_caster_outglow'
         RenderTwoSided=True
         ...
         AutomaticInitialSpawning=False
         DrawStyle=PTDS_Brighten
         CustomMaterials(0)=Shader'LineageEffectsTextures2.lindvior.outglow_caster_shader'
         CustomMaterials(1)=Shader'LineageEffectsTextures2.lindvior.outglow_caster_shader1'
         LifetimeRange=(Min=1.500000,Max=1.500000)
         WarmupTicksPerSecond=1.000000
         RelativeWarmupTime=1.000000
         Name="MeshEmitter199"
     End Object
     Emitters(3)=MeshEmitter'LineageEffect.weapon_lind_caster_simple.MeshEmitter199'
     Begin Object Class=MeshEmitter Name=MeshEmitter222
         StaticMesh=StaticMesh'LineageEffectsStaticmeshes2.Weapon.lind_caster_m00'
         RenderTwoSided=True
         ColorScale(0)=(Color=(B=255,G=255,R=255,A=255))
         ...
         AutomaticInitialSpawning=False
         CustomMaterials(0)=Shader'LineageEffectsTextures2.lindvior.Lind_caster_glow_Shader'
         LifetimeRange=(Min=1.000000,Max=1.000000)
         Name="MeshEmitter222"
     End Object
     Emitters(4)=MeshEmitter'LineageEffect.weapon_lind_caster_simple.MeshEmitter222'
     Begin Object Class=MeshEmitter Name=MeshEmitter223
         ...
         SizeScale(0)=(RelativeSize=0.800000)
         SizeScale(1)=(RelativeTime=1.000000,RelativeSize=1.250000)
         StartSizeRange=(X=(Min=0.150000,Max=0.300000),Y=(Min=0.150000,Max=0.300000),Z=(Min=0.500000,Max=0.800000))
         ...
         Name="MeshEmitter223"
     End Object
     Emitters(5)=MeshEmitter'LineageEffect.weapon_lind_caster_simple.MeshEmitter223'
     Begin Object Class=MeshEmitter Name=MeshEmitter224
         ...
         AutomaticInitialSpawning=False
         CustomMaterials(0)=Texture'LineageEffectsTextures2.lindvior.fx_m_t6302'
         LifetimeRange=(Min=1.000000,Max=1.000000)
         Name="MeshEmitter224"
     End Object
     Emitters(6)=MeshEmitter'LineageEffect.weapon_lind_caster_simple.MeshEmitter224'
     Begin Object Class=MeshEmitter Name=MeshEmitter225
         ...
         StartSizeRange=(X=(Min=0.263000,Max=0.263000),Y=(Min=0.263000,Max=0.263000),Z=(Min=0.391000,Max=0.391000))
         InitialParticlesPerSecond=5.000000
         AutomaticInitialSpawning=False
         ...
         Name="MeshEmitter225"
     End Object
     Emitters(7)=MeshEmitter'LineageEffect.weapon_lind_caster_simple.MeshEmitter225'
     Begin Object Class=MeshEmitter Name=MeshEmitter226
         ...
         FadeIn=True
         MaxParticles=4
         StartLocationRange=(Z=(Min=2.000000,Max=7.000000))
         SpinParticles=True
         SpinCCWorCW=(X=0.000000)
         ...
         StartSizeRange=(X=(Min=1.200000,Max=1.800000),Y=(Min=1.200000,Max=1.800000),Z=(Min=0.800000,Max=1.000000))
         ...
         Name="MeshEmitter226"
     End Object
     Emitters(8)=MeshEmitter'LineageEffect.weapon_lind_caster_simple.MeshEmitter226'
     bLightChanged=True
     bNoDelete=False
     bSunAffect=True
     DrawScale=0.100000
