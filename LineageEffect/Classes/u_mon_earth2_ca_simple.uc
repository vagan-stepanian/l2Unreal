class u_mon_earth2_ca_simple extends Emitter;

defaultproperties
{
     Begin Object Class=MeshEmitter Name=MeshEmitter271
         ...
         Name="MeshEmitter271"
     End Object
     Emitters(0)=MeshEmitter'LineageEffect.u_mon_earth2_ca_simple.MeshEmitter271'
     Begin Object Class=MeshEmitter Name=MeshEmitter272
         StaticMesh=StaticMesh'LineageEffectsStaticmeshes.Fire.fireRoll'
         UseMeshBlendMode=False
         RenderTwoSided=True
         Acceleration=(Z=40.000000)
         UseColorScale=True
         ColorScale(0)=(Color=(B=133,G=183,R=188,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=31,G=61,R=43,A=255))
         ColorMultiplierRange=(X=(Min=0.200000,Max=0.200000),Y=(Min=1.000000,Max=1.000000),Z=(Min=0.800000,Max=0.800000))
         ...
         Name="MeshEmitter272"
     End Object
     Emitters(1)=MeshEmitter'LineageEffect.u_mon_earth2_ca_simple.MeshEmitter272'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter374
         ...
         Name="SpriteEmitter374"
     End Object
     Emitters(2)=SpriteEmitter'LineageEffect.u_mon_earth2_ca_simple.SpriteEmitter374'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter375
         UseDirectionAs=PTDU_Normal
         UseColorScale=True
         ColorScale(0)=(Color=(B=119,G=159,R=221,A=255))
         ColorScale(1)=(RelativeTime=0.539286,Color=(B=66,G=189,R=90,A=255))
         ColorScale(2)=(RelativeTime=1.000000,Color=(B=130,G=166,R=77,A=255))
         ...
         LifetimeRange=(Min=0.750000,Max=0.750000)
         InitialDelayRange=(Min=0.100000,Max=0.100000)
         Name="SpriteEmitter375"
     End Object
     Emitters(3)=SpriteEmitter'LineageEffect.u_mon_earth2_ca_simple.SpriteEmitter375'
     Begin Object Class=MeshEmitter Name=MeshEmitter273
         ...
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=131,G=222,R=197,A=255))
         Opacity=0.430000
         ...
         Name="MeshEmitter273"
     End Object
     Emitters(4)=MeshEmitter'LineageEffect.u_mon_earth2_ca_simple.MeshEmitter273'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter376
         UseColorScale=True
         ColorScale(0)=(Color=(B=156,G=218,R=194,A=255))
         ColorScale(1)=(RelativeTime=0.546429,Color=(B=65,G=65,R=65,A=255))
         ColorScale(2)=(RelativeTime=1.000000,Color=(B=159,G=199,R=116,A=255))
     ...
     End Object
     Emitters(5)=SpriteEmitter'LineageEffect.u_mon_earth2_ca_simple.SpriteEmitter376'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter377
         UseDirectionAs=PTDU_Forward
         UseColorScale=True
         ColorScale(0)=(Color=(B=35,G=99,R=156,A=255))
         ColorScale(1)=(RelativeTime=0.496429,Color=(B=77,G=166,R=255,A=255))
         ColorScale(2)=(RelativeTime=1.000000,Color=(B=71,G=134,R=57,A=255))
     ...
     End Object
     Emitters(6)=SpriteEmitter'LineageEffect.u_mon_earth2_ca_simple.SpriteEmitter377'
