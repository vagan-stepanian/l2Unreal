class u_su_touch_y_ca extends Emitter;
...
defaultproperties
{
     Begin Object Class=MeshEmitter Name=MeshEmitter183
         ...
         Name="MeshEmitter183"
     End Object
     Emitters(0)=MeshEmitter'LineageEffect.u_su_touch_y_ca.MeshEmitter183'
     ...
     End Object
     Emitters(1)=SpriteEmitter'LineageEffect.u_su_touch_y_ca.SpriteEmitter103'
     Begin Object Class=MeshEmitter Name=MeshEmitter184
         ...
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=2,G=197,R=253,A=255))
         ColorMultiplierRange=(X=(Min=0.800000,Max=0.800000),Y=(Min=0.800000,Max=0.800000),Z=(Min=0.100000,Max=0.100000))
         Opacity=0.500000
         ...
         Name="MeshEmitter184"
     End Object
     Emitters(2)=MeshEmitter'LineageEffect.u_su_touch_y_ca.MeshEmitter184'
     Begin Object Class=VertMeshEmitter Name=VertMeshEmitter31
         AnimRate(2)=0.050055
         AnimRate(3)=0.954206
         AnimRate(4)=0.906109
         AnimRate(5)=0.808610
         ...
         AnimRate(8)=0.610586
         AnimRate(9)=0.561103
         AnimRate(10)=0.462107
         AnimRate(11)=0.412598
         AnimRate(12)=0.315110
         AnimRate(13)=0.267097
         AnimRate(14)=0.171080
         ...
         Name="VertMeshEmitter31"
     End Object
     Emitters(3)=VertMeshEmitter'LineageEffect.u_su_touch_y_ca.VertMeshEmitter31'
     Begin Object Class=MeshEmitter Name=MeshEmitter185
         ...
         UseColorScale=True
         ColorScale(0)=(Color=(B=255,G=255,R=255,A=255))
         ColorScale(1)=(RelativeTime=0.525000,Color=(G=96,R=128,A=255))
         ...
         Name="MeshEmitter185"
     End Object
     Emitters(4)=MeshEmitter'LineageEffect.u_su_touch_y_ca.MeshEmitter185'
     Begin Object Class=MeshEmitter Name=MeshEmitter186
         ...
         ColorMultiplierRange=(X=(Min=1.000000,Max=1.000000),Y=(Min=1.000000,Max=1.000000),Z=(Min=0.150000,Max=0.150000))
         ...
         Name="MeshEmitter186"
     End Object
     Emitters(5)=MeshEmitter'LineageEffect.u_su_touch_y_ca.MeshEmitter186'
     Begin Object Class=MeshEmitter Name=MeshEmitter187
         ...
         Name="MeshEmitter187"
     End Object
     Emitters(6)=MeshEmitter'LineageEffect.u_su_touch_y_ca.MeshEmitter187'
     Begin Object Class=MeshEmitter Name=MeshEmitter188
         ...
         Name="MeshEmitter188"
     End Object
     Emitters(7)=MeshEmitter'LineageEffect.u_su_touch_y_ca.MeshEmitter188'
     ...
     End Object
     Emitters(8)=SpriteEmitter'LineageEffect.u_su_touch_y_ca.SpriteEmitter104'
     bNoDelete=False
}
