class range_region_decal_blue_simple extends ProjectedEmitter;
...
defaultproperties
{
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter1
         UseColorScale=True
         ColorScale(0)=(Color=(B=208,G=208,R=208,A=255))
         ColorScale(1)=(RelativeTime=0.507143,Color=(B=121,G=121,R=121,A=255))
         ...
         Name="SpriteEmitter1"
     End Object
     Emitters(0)=SpriteEmitter'LineageEffect.range_region_decal_blue_simple.SpriteEmitter1'
     bLightChanged=True
     bNoDelete=False
     bSunAffect=True
}
