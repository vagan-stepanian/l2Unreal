class u_raid_mon_deco extends Emitter;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'LineageEffect.u_raid_mon_deco.SpriteEmitter51'
     ...
     End Object
     Emitters(1)=SpriteEmitter'LineageEffect.u_raid_mon_deco.SpriteEmitter53'
     bLightChanged=True
     bNoDelete=False
     bSunAffect=True
     DrawScale=0.200000
