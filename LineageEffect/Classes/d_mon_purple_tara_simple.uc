class d_mon_purple_tara_simple extends Emitter;
...
defaultproperties
{
     Begin Object Class=MeshEmitter Name=MeshEmitter42
         ...
         Name="MeshEmitter42"
     End Object
     Emitters(0)=MeshEmitter'LineageEffect.d_mon_purple_tara_simple.MeshEmitter42'
     ...
     End Object
     Emitters(1)=SpriteEmitter'LineageEffect.d_mon_purple_tara_simple.SpriteEmitter70'
     ...
     End Object
     Emitters(2)=SpriteEmitter'LineageEffect.d_mon_purple_tara_simple.SpriteEmitter71'
     ...
     End Object
     Emitters(3)=SpriteEmitter'LineageEffect.d_mon_purple_tara_simple.SpriteEmitter72'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter73
         Acceleration=(Z=30.000000)
         UseColorScale=True
         ColorScale(0)=(Color=(B=214,G=105,R=194,A=255))
     ...
     End Object
     Emitters(4)=SpriteEmitter'LineageEffect.d_mon_purple_tara_simple.SpriteEmitter73'
     Begin Object Class=MeshEmitter Name=MeshEmitter43
         ...
         UseColorScale=True
         ColorScale(0)=(Color=(B=171,G=77,R=179,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(A=255))
         ColorMultiplierRange=(X=(Min=0.800000,Max=0.800000),Y=(Min=0.600000,Max=0.600000),Z=(Min=1.000000,Max=1.000000))
         Opacity=0.700000
         ...
         Name="MeshEmitter43"
     End Object
     Emitters(5)=MeshEmitter'LineageEffect.d_mon_purple_tara_simple.MeshEmitter43'
     ...
     End Object
     Emitters(6)=SpriteEmitter'LineageEffect.d_mon_purple_tara_simple.SpriteEmitter74'
     ...
     End Object
     Emitters(7)=SpriteEmitter'LineageEffect.d_mon_purple_tara_simple.SpriteEmitter75'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter76
         UseDirectionAs=PTDU_Up
         UseColorScale=True
         ColorScale(0)=(Color=(B=192,G=126,R=165,A=255))
         ColorScale(1)=(RelativeTime=0.757143,Color=(B=136,G=70,R=185,A=255))
         ColorScale(2)=(RelativeTime=1.000000,Color=(B=163,G=92,R=160,A=255))
         Opacity=0.850000
     ...
     End Object
     Emitters(8)=SpriteEmitter'LineageEffect.d_mon_purple_tara_simple.SpriteEmitter76'
     ...
     End Object
     Emitters(9)=SpriteEmitter'LineageEffect.d_mon_purple_tara_simple.SpriteEmitter77'
     ...
     End Object
     Emitters(10)=SpriteEmitter'LineageEffect.d_mon_purple_tara_simple.SpriteEmitter78'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter79
         UseDirectionAs=PTDU_Up
         Acceleration=(Z=70.000000)
         UseColorScale=True
         ColorScale(0)=(Color=(B=143,G=81,R=170,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=181,G=74,R=181,A=255))
     ...
     End Object
     Emitters(11)=SpriteEmitter'LineageEffect.d_mon_purple_tara_simple.SpriteEmitter79'
     ...
     End Object
     Emitters(12)=SpriteEmitter'LineageEffect.d_mon_purple_tara_simple.SpriteEmitter80'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter81
         UseDirectionAs=PTDU_Up
         UseColorScale=True
         ColorScale(0)=(Color=(B=130,G=55,R=132,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=159,G=74,R=181,A=255))
     ...
     End Object
     Emitters(13)=SpriteEmitter'LineageEffect.d_mon_purple_tara_simple.SpriteEmitter81'
     AutoReplay=True
     bLightChanged=True
     bNoDelete=False
     bSunAffect=True
