class d_herb_magic_ave_simple extends Emitter;
...
defaultproperties
{
     Begin Object Class=MeshEmitter Name=MeshEmitter0
         ...
         RenderTwoSided=True
         UseColorScale=True
         ColorScale(0)=(Color=(B=187,G=94,A=255))
         ColorScale(1)=(RelativeTime=0.710714,Color=(B=255,G=163,R=128,A=255))
         ColorScale(2)=(RelativeTime=1.000000,Color=(B=206,G=255,R=91,A=255))
         ...
         Name="MeshEmitter0"
     End Object
     Emitters(0)=MeshEmitter'LineageEffect.d_herb_magic_ave_simple.MeshEmitter0'
     Begin Object Class=MeshEmitter Name=MeshEmitter1
         ...
         Name="MeshEmitter1"
     End Object
     Emitters(1)=MeshEmitter'LineageEffect.d_herb_magic_ave_simple.MeshEmitter1'
     AutoDestroy=False
     bNoDelete=False
     DrawScale=0.100000
}
