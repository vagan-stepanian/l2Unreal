class s_u804_big_ca_simple extends Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter57
         ...
         StartSizeRange=(X=(Min=105.000000,Max=105.000000),Y=(Min=105.000000,Max=105.000000),Z=(Min=105.000000,Max=105.000000))
     ...
     End Object
     Emitters(0)=SpriteEmitter'LineageEffect.s_u804_big_ca_simple.SpriteEmitter57'
     ...
     End Object
     Emitters(1)=SpriteEmitter'LineageEffect.s_u804_big_ca_simple.SpriteEmitter58'
     Begin Object Class=MeshEmitter Name=MeshEmitter34
         ...
         StartSizeRange=(X=(Min=0.750000,Max=0.750000),Y=(Min=0.750000,Max=0.750000),Z=(Min=2.100000,Max=2.100000))
         InitialParticlesPerSecond=50.000000
         AutomaticInitialSpawning=False
         DrawStyle=PTDS_Brighten
         StartVelocityRange=(Z=(Min=3.000000,Max=15.000000))
         VelocityLossRange=(X=(Max=1.000000),Y=(Max=1.000000),Z=(Max=1.000000))
         Name="MeshEmitter34"
     End Object
     Emitters(2)=MeshEmitter'LineageEffect.s_u804_big_ca_simple.MeshEmitter34'
     Begin Object Class=MeshEmitter Name=MeshEmitter35
         ...
         Name="MeshEmitter35"
     End Object
     Emitters(3)=MeshEmitter'LineageEffect.s_u804_big_ca_simple.MeshEmitter35'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter59
         ...
         StartLocationRange=(X=(Min=-9.000000,Max=9.000000),Y=(Min=-9.000000,Max=9.000000),Z=(Min=-30.000000,Max=30.000000))
         ...
         StartSizeRange=(X=(Min=60.000000,Max=105.000000),Y=(Min=60.000000,Max=105.000000),Z=(Min=60.000000,Max=105.000000))
         ...
         StartVelocityRange=(X=(Min=-0.450000,Max=0.450000),Y=(Min=-0.450000,Max=0.450000),Z=(Min=0.900000,Max=2.100000))
         Name="SpriteEmitter59"
     End Object
     Emitters(4)=SpriteEmitter'LineageEffect.s_u804_big_ca_simple.SpriteEmitter59'
     Begin Object Class=VertMeshEmitter Name=VertMeshEmitter8
         ...
         StartSizeRange=(X=(Min=0.120000,Max=0.210000),Y=(Min=0.120000,Max=0.210000),Z=(Min=0.120000,Max=0.210000))
         InitialParticlesPerSecond=10.000000
         AutomaticInitialSpawning=False
         DrawStyle=PTDS_Brighten
         LifetimeRange=(Min=1.200000,Max=1.200000)
         StartVelocityRange=(Z=(Min=45.000000,Max=90.000000))
         VelocityLossRange=(X=(Max=1.000000),Y=(Max=1.000000),Z=(Max=1.000000))
         Name="VertMeshEmitter8"
     End Object
     Emitters(5)=VertMeshEmitter'LineageEffect.s_u804_big_ca_simple.VertMeshEmitter8'
     Begin Object Class=MeshEmitter Name=MeshEmitter2
         ...
         SizeScale(2)=(RelativeTime=1.000000,RelativeSize=2.200000)
         StartSizeRange=(X=(Min=1.200000,Max=1.500000),Y=(Min=1.200000,Max=1.500000),Z=(Min=0.300000,Max=0.600000))
         InitialParticlesPerSecond=100.000000
         AutomaticInitialSpawning=False
         LifetimeRange=(Min=3.500000,Max=4.000000)
         Name="MeshEmitter2"
     End Object
     Emitters(6)=MeshEmitter'LineageEffect.s_u804_big_ca_simple.MeshEmitter2'
     bLightChanged=True
     bNoDelete=False
     bSunAffect=True
     DrawScale=0.200000
