class u_su_power_y_ra extends Emitter;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'LineageEffect.u_su_power_y_ra.SpriteEmitter50'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter51
         Acceleration=(Z=-80.000000)
         UseColorScale=True
         ColorScale(0)=(Color=(B=255,G=255,R=255,A=255))
         ColorScale(1)=(RelativeTime=0.275000,Color=(B=118,G=167,R=203,A=255))
         ColorScale(2)=(RelativeTime=0.596429,Color=(B=85,G=253,R=240,A=255))
     ...
     End Object
     Emitters(1)=SpriteEmitter'LineageEffect.u_su_power_y_ra.SpriteEmitter51'
     Begin Object Class=MeshEmitter Name=MeshEmitter78
         ...
         Name="MeshEmitter78"
     End Object
     Emitters(2)=MeshEmitter'LineageEffect.u_su_power_y_ra.MeshEmitter78'
     Begin Object Class=VertMeshEmitter Name=VertMeshEmitter11
         VertexMesh=VertMesh'LineageEffectMeshes.hornz'
         UseMeshBlendMode=False
         UseColorScale=True
         ColorScale(0)=(Color=(B=136,G=247,R=255,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=104,G=255,R=248,A=255))
         ColorMultiplierRange=(X=(Min=0.300000,Max=1.000000),Y=(Min=0.300000,Max=0.900000),Z=(Min=0.200000,Max=0.600000))
         Opacity=0.250000
     ...
     End Object
     Emitters(3)=VertMeshEmitter'LineageEffect.u_su_power_y_ra.VertMeshEmitter11'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter52
         UseColorScale=True
         ColorScale(0)=(Color=(B=255,G=255,R=128,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(G=255,R=204,A=255))
         Opacity=0.200000
         FadeOutStartTime=0.240000
         FadeOut=True
     ...
     End Object
     Emitters(4)=SpriteEmitter'LineageEffect.u_su_power_y_ra.SpriteEmitter52'
     Begin Object Class=MeshEmitter Name=MeshEmitter79
         StaticMesh=StaticMesh'LineageEffectsStaticmeshes.Bereth.Rotroll'
         UseMeshBlendMode=False
         RenderTwoSided=True
         UseColorScale=True
         ColorScale(0)=(Color=(B=128,G=255,R=242,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=1,G=203,R=254,A=255))
         Opacity=0.750000
         ...
         Name="MeshEmitter79"
     End Object
     Emitters(5)=MeshEmitter'LineageEffect.u_su_power_y_ra.MeshEmitter79'
     Begin Object Class=MeshEmitter Name=MeshEmitter80
         ...
         Name="MeshEmitter80"
     End Object
     Emitters(6)=MeshEmitter'LineageEffect.u_su_power_y_ra.MeshEmitter80'
     Begin Object Class=MeshEmitter Name=MeshEmitter81
         ...
         Name="MeshEmitter81"
     End Object
     Emitters(7)=MeshEmitter'LineageEffect.u_su_power_y_ra.MeshEmitter81'
     Begin Object Class=MeshEmitter Name=MeshEmitter82
         ...
         Name="MeshEmitter82"
     End Object
     Emitters(8)=MeshEmitter'LineageEffect.u_su_power_y_ra.MeshEmitter82'
     bNoDelete=False
}
