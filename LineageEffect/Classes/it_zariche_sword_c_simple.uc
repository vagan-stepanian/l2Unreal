class it_zariche_sword_c_simple extends Emitter;
...
defaultproperties
{
     Begin Object Class=MeshEmitter Name=MeshEmitter50
         ...
         Name="MeshEmitter50"
     End Object
     Emitters(0)=MeshEmitter'LineageEffect.it_zariche_sword_c_simple.MeshEmitter50'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter56
         UseDirectionAs=PTDU_UpAndNormal
         Acceleration=(Y=-0.200000)
         ...
         FadeIn=True
         StartLocationOffset=(X=17.000000,Y=3.000000)
         ...
         StartSizeRange=(X=(Min=5.000000,Max=8.000000),Y=(Min=15.000000,Max=15.000000),Z=(Min=5.000000,Max=8.000000))
         ...
         StartVelocityRange=(X=(Min=5.500000,Max=5.500000))
         Name="SpriteEmitter56"
     End Object
     Emitters(1)=SpriteEmitter'LineageEffect.it_zariche_sword_c_simple.SpriteEmitter56'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter57
         ...
         FadeIn=True
         MaxParticles=20
         StartLocationOffset=(X=15.000000,Y=3.000000)
     ...
     End Object
     Emitters(2)=SpriteEmitter'LineageEffect.it_zariche_sword_c_simple.SpriteEmitter57'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter71
         ...
         StartLocationRange=(X=(Min=-5.000000,Max=5.000000),Y=(Min=-2.000000,Max=2.000000),Z=(Min=-1.500000,Max=1.500000))
         SpinParticles=True
         UseRegularSizeScale=False
         SizeScale(0)=(RelativeSize=1.000000)
         SizeScale(1)=(RelativeTime=1.000000,RelativeSize=0.300000)
     ...
     End Object
     Emitters(3)=SpriteEmitter'LineageEffect.it_zariche_sword_c_simple.SpriteEmitter71'
     ...
     End Object
     Emitters(4)=SpriteEmitter'LineageEffect.it_zariche_sword_c_simple.SpriteEmitter72'
     Begin Object Class=MeshEmitter Name=MeshEmitter51
         ...
         FadeIn=True
         MaxParticles=5
         StartLocationOffset=(X=18.000000,Y=3.000000)
         SpinParticles=True
         ...
         Name="MeshEmitter51"
     End Object
     Emitters(5)=MeshEmitter'LineageEffect.it_zariche_sword_c_simple.MeshEmitter51'
     Begin Object Class=MeshEmitter Name=MeshEmitter52
         ...
         Name="MeshEmitter52"
     End Object
     Emitters(6)=MeshEmitter'LineageEffect.it_zariche_sword_c_simple.MeshEmitter52'
     Begin Object Class=MeshEmitter Name=MeshEmitter53
         StaticMesh=StaticMesh'LineageEffectsStaticmeshes.etc.spirit_gun00'
         UseMeshBlendMode=False
         RenderTwoSided=True
         Acceleration=(Y=-0.550000)
         UseColorScale=True
         ColorScale(0)=(Color=(B=132,G=132,R=255,A=255))
         ColorScale(1)=(RelativeTime=0.507143,Color=(B=255,G=255,R=255,A=255))
         ColorScale(2)=(RelativeTime=1.000000,Color=(B=134,G=134,R=255,A=255))
         ...
         FadeIn=True
         StartLocationOffset=(X=12.000000,Y=3.000000)
         SpinParticles=True
         SpinCCWorCW=(Z=0.000000)
         SpinsPerSecondRange=(Z=(Min=0.300000,Max=0.500000))
         ...
         StartSizeRange=(X=(Min=0.100000,Max=0.200000),Y=(Min=0.060000,Max=0.060000),Z=(Min=0.060000,Max=0.060000))
         InitialParticlesPerSecond=1.000000
         AutomaticInitialSpawning=False
         StartVelocityRange=(X=(Min=10.000000,Max=10.000000))
         Name="MeshEmitter53"
     End Object
     Emitters(7)=MeshEmitter'LineageEffect.it_zariche_sword_c_simple.MeshEmitter53'
     Begin Object Class=MeshEmitter Name=MeshEmitter54
         StaticMesh=StaticMesh'LineageEffectsStaticmeshes.etc.spirit_gun00'
         UseMeshBlendMode=False
         RenderTwoSided=True
         Acceleration=(Y=0.300000)
         UseColorScale=True
         ColorScale(0)=(Color=(B=132,G=132,R=255,A=255))
         ColorScale(1)=(RelativeTime=0.507143,Color=(B=255,G=255,R=255,A=255))
         ColorScale(2)=(RelativeTime=1.000000,Color=(B=134,G=134,R=255,A=255))
         ...
         FadeInEndTime=0.480000
         FadeIn=True
         StartLocationOffset=(X=8.000000,Y=1.000000)
         SpinParticles=True
         SpinCCWorCW=(Z=0.000000)
         SpinsPerSecondRange=(Z=(Min=0.300000,Max=0.500000))
         StartSpinRange=(Z=(Min=-1.000000,Max=1.000000))
         ...
         SizeScale(1)=(RelativeTime=0.500000,RelativeSize=1.100000)
         SizeScale(2)=(RelativeTime=1.000000,RelativeSize=0.500000)
         StartSizeRange=(X=(Min=0.080000,Max=0.080000),Y=(Min=0.100000,Max=0.100000),Z=(Min=0.100000,Max=0.100000))
         InitialParticlesPerSecond=1.000000
         AutomaticInitialSpawning=False
         StartVelocityRange=(X=(Min=5.000000,Max=5.000000))
         Name="MeshEmitter54"
     End Object
     Emitters(8)=MeshEmitter'LineageEffect.it_zariche_sword_c_simple.MeshEmitter54'
     Begin Object Class=MeshEmitter Name=MeshEmitter55
         ...
         Name="MeshEmitter55"
     End Object
     Emitters(9)=MeshEmitter'LineageEffect.it_zariche_sword_c_simple.MeshEmitter55'
     ...
     End Object
     Emitters(10)=SpriteEmitter'LineageEffect.it_zariche_sword_c_simple.SpriteEmitter60'
     bLightChanged=True
     bNoDelete=False
     bSunAffect=True
     Rotation=(Yaw=8)
