class z_common_short_ca extends Emitter;
...
defaultproperties
{
     Begin Object Class=MeshEmitter Name=MeshEmitter23
         ...
         ColorScale(2)=(RelativeTime=0.703571,Color=(B=64,G=128,R=255,A=255))
         ...
         LifetimeRange=(Min=0.300100,Max=0.600100)
         Name="MeshEmitter23"
     End Object
     Emitters(0)=MeshEmitter'LineageEffect.z_common_short_ca.MeshEmitter23'
     bNoDelete=False
     bSunAffect=True
}
