class d_mon_green4_ra extends Emitter;
...
defaultproperties
{
     ...
     End Object
     Emitters(1)=VertMeshEmitter'LineageEffect.d_mon_green4_ra.VertMeshEmitter6'
     Begin Object Class=MeshEmitter Name=MeshEmitter15
         StaticMesh=StaticMesh'LineageEffectsStaticmeshes2.miyun.sphere_01'
         UseMeshBlendMode=False
         RenderTwoSided=True
         UseColorScale=True
         ColorScale(0)=(Color=(B=175,G=237,R=192,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=114,G=176,R=87,A=255))
         ColorScaleRepeats=3.000000
         ...
         Name="MeshEmitter15"
     End Object
     Emitters(2)=MeshEmitter'LineageEffect.d_mon_green4_ra.MeshEmitter15'
     Begin Object Class=MeshEmitter Name=MeshEmitter16
         ...
         Name="MeshEmitter16"
     End Object
     Emitters(3)=MeshEmitter'LineageEffect.d_mon_green4_ra.MeshEmitter16'
     Begin Object Class=VertMeshEmitter Name=VertMeshEmitter7
         VertexMesh=VertMesh'LineageEffectMeshes2.mi_sphere_40'
         UseMeshBlendMode=False
         UseColorScale=True
         ColorScale(0)=(Color=(B=255,G=255,R=255,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=24,G=84,R=33,A=255))
         Opacity=0.790000
     ...
     End Object
     Emitters(4)=VertMeshEmitter'LineageEffect.d_mon_green4_ra.VertMeshEmitter7'
     AutoReplay=True
     bNoDelete=False
}
