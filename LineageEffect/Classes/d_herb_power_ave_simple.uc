class d_herb_power_ave_simple extends Emitter;
...
defaultproperties
{
     Begin Object Class=MeshEmitter Name=MeshEmitter8
         ...
         ColorScale(1)=(RelativeTime=0.725000,Color=(B=107,G=107,R=228,A=255))
         ColorScale(2)=(RelativeTime=1.000000,Color=(B=166,G=166,R=208,A=255))
         ...
         Name="MeshEmitter8"
     End Object
     Emitters(0)=MeshEmitter'LineageEffect.d_herb_power_ave_simple.MeshEmitter8'
     Begin Object Class=MeshEmitter Name=MeshEmitter9
         ...
         Name="MeshEmitter9"
     End Object
     Emitters(1)=MeshEmitter'LineageEffect.d_herb_power_ave_simple.MeshEmitter9'
     AutoDestroy=False
     bNoDelete=False
     DrawScale=0.100000
}
