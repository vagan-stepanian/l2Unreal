class e_u314_ca_simple extends Emitter;
...
defaultproperties
{
     Begin Object Class=MeshEmitter Name=MeshEmitter3
         ...
         Name="MeshEmitter3"
     End Object
     Emitters(0)=MeshEmitter'LineageEffect.e_u314_ca_simple.MeshEmitter3'
     Begin Object Class=MeshEmitter Name=MeshEmitter7
         StaticMesh=StaticMesh'LineageEffectsStaticmeshes.water.tears_water'
         UseMeshBlendMode=False
         RenderTwoSided=True
         UseColorScale=True
         ColorScale(0)=(Color=(B=77,G=106,R=128,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=117,G=116,R=115,A=255))
         ...
         Name="MeshEmitter7"
     End Object
     Emitters(1)=MeshEmitter'LineageEffect.e_u314_ca_simple.MeshEmitter7'
     Begin Object Class=MeshEmitter Name=MeshEmitter8
         ...
         UseColorScale=True
         ColorScale(0)=(Color=(B=77,G=96,R=104,A=255))
         ColorScale(1)=(RelativeTime=0.507143,Color=(B=106,G=139,R=166,A=255))
         ...
         Name="MeshEmitter8"
     End Object
     Emitters(2)=MeshEmitter'LineageEffect.e_u314_ca_simple.MeshEmitter8'
     Begin Object Class=MeshEmitter Name=MeshEmitter9
         ...
         Name="MeshEmitter9"
     End Object
     Emitters(3)=MeshEmitter'LineageEffect.e_u314_ca_simple.MeshEmitter9'
     bLightChanged=True
     bNoDelete=False
     bSunAffect=True
