class u_kn_pledge_y_ca_simple extends Emitter;
...
defaultproperties
{
     Begin Object Class=MeshEmitter Name=MeshEmitter2
         ...
         ColorScale(1)=(RelativeTime=0.325000,Color=(B=64,G=169,R=255,A=255))
         ColorScale(2)=(RelativeTime=1.000000,Color=(B=12,G=145,R=254,A=255))
         Opacity=0.100000
         ...
         Name="MeshEmitter2"
     End Object
     Emitters(0)=MeshEmitter'LineageEffect.u_kn_pledge_y_ca_simple.MeshEmitter2'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter6
         UseDirectionAs=PTDU_Forward
         UseColorScale=True
         ColorScale(0)=(Color=(B=92,G=254,R=218,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(G=191,R=255,A=255))
         ...
         Name="SpriteEmitter6"
     End Object
     Emitters(1)=SpriteEmitter'LineageEffect.u_kn_pledge_y_ca_simple.SpriteEmitter6'
     bNoDelete=False
}
