class br_e_u094_shiny_light_a_simple extends Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter91
         ...
         ColorScale(2)=(RelativeTime=0.807143,Color=(B=131,G=131,R=131,A=255))
     ...
     End Object
     Emitters(0)=SpriteEmitter'LineageEffect.br_e_u094_shiny_light_a_simple.SpriteEmitter91'
     bLightChanged=True
     bNoDelete=False
     bSunAffect=True
     Rotation=(Yaw=4880480)
     DrawScale=0.050000
     SwayRotationOrig=(Yaw=4469262)
}
