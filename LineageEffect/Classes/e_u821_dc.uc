class e_u821_dc extends Emitter;
...
defaultproperties
{
     Begin Object Class=VertMeshEmitter Name=VertMeshEmitter7
         ...
         StartSizeRange=(X=(Min=0.500000,Max=0.500000),Y=(Min=0.350000,Max=0.350000),Z=(Min=0.100000,Max=0.100000))
         InitialParticlesPerSecond=30.000000
         AutomaticInitialSpawning=False
         LifetimeRange=(Min=1.000000,Max=1.000000)
         Name="VertMeshEmitter7"
     End Object
     Emitters(0)=VertMeshEmitter'LineageEffect.e_u821_dc.VertMeshEmitter7'
     ...
     End Object
     Emitters(1)=SpriteEmitter'LineageEffect.e_u821_dc.SpriteEmitter449'
     bLightChanged=True
     bNoDelete=False
     Rotation=(Yaw=31592)
     DrawScale=0.300000
