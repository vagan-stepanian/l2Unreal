class d_harnak2_bg_simple extends Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter102
         ...
         Texture=Texture'LineageEffectsTextures.Particles6.fx_m_t6126'
     ...
     End Object
     Emitters(0)=SpriteEmitter'LineageEffect.d_harnak2_bg_simple.SpriteEmitter102'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter103
         UseColorScale=True
         ColorScale(0)=(Color=(B=255,G=255,R=255,A=255))
         ColorScale(1)=(RelativeTime=0.539286,Color=(B=21,G=21,R=21,A=255))
         ColorScale(2)=(RelativeTime=1.000000,Color=(B=255,G=255,R=255,A=255))
         ColorScaleRepeats=6.000000
         ColorMultiplierRange=(Y=(Min=1.000000,Max=1.000000),Z=(Min=0.200000,Max=0.200000))
         Opacity=0.500000
         ...
         UseRandomSubdivision=True
         SubdivisionEnd=16
         LifetimeRange=(Min=36.000000,Max=36.000000)
         WarmupTicksPerSecond=1.000000
         RelativeWarmupTime=1.000000
         Name="SpriteEmitter103"
     End Object
     Emitters(1)=SpriteEmitter'LineageEffect.d_harnak2_bg_simple.SpriteEmitter103'
     Begin Object Class=BeamEmitter Name=BeamEmitter4
         ...
         ColorMultiplierRange=(X=(Min=0.100000,Max=0.100000),Y=(Min=0.500000,Max=0.500000),Z=(Min=0.100000,Max=0.100000))
         ...
         Name="BeamEmitter4"
     End Object
     Emitters(2)=BeamEmitter'LineageEffect.d_harnak2_bg_simple.BeamEmitter4'
     Begin Object Class=BeamEmitter Name=BeamEmitter5
         BeamEndPoints(0)=(offset=(Z=(Min=180.000000,Max=180.000000)))
         DetermineEndPointBy=PTEP_Offset
         BeamTextureUScale=-0.900000
         LowFrequencyPoints=2
         HighFrequencyPoints=2
         ...
         Name="BeamEmitter5"
     End Object
     Emitters(3)=BeamEmitter'LineageEffect.d_harnak2_bg_simple.BeamEmitter5'
     ...
     End Object
     Emitters(4)=SpriteEmitter'LineageEffect.d_harnak2_bg_simple.SpriteEmitter104'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter105
         ...
         StartVelocityRange=(X=(Min=-9.600000,Max=9.600000),Y=(Min=-9.600000,Max=9.600000),Z=(Min=36.000000,Max=52.000000))
     ...
     End Object
     Emitters(5)=SpriteEmitter'LineageEffect.d_harnak2_bg_simple.SpriteEmitter105'
     ...
     End Object
     Emitters(6)=SpriteEmitter'LineageEffect.d_harnak2_bg_simple.SpriteEmitter108'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter109
         UseDirectionAs=PTDU_Normal
         ColorScale(0)=(Color=(B=255,G=255,R=255,A=255))
         ColorScale(1)=(RelativeTime=0.539286,Color=(B=110,G=110,R=110,A=255))
         ColorScale(2)=(RelativeTime=1.000000,Color=(B=255,G=255,R=255,A=255))
         ColorMultiplierRange=(X=(Min=0.300000,Max=0.300000),Y=(Min=1.000000,Max=1.000000),Z=(Min=0.200000,Max=0.200000))
         Opacity=0.500000
         MaxParticles=3
         UseSizeScale=True
         UseRegularSizeScale=False
     ...
     End Object
     Emitters(7)=SpriteEmitter'LineageEffect.d_harnak2_bg_simple.SpriteEmitter109'
