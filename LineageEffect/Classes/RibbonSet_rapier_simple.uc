...
// KFTATTRibbon.
//=============================================================================
class RibbonSet_rapier_simple extends Emitter
	placeable;
...
defaultproperties
{
     Begin Object Class=RibbonEmitter Name=RibbonEmitter0
         ...
         Texture=Texture'LineageEffectsTextures.Particles.fx_m_t0091'
         Name="RibbonEmitter0"
     End Object
     Emitters(0)=RibbonEmitter'LineageEffect.RibbonSet_rapier_simple.RibbonEmitter0'
     bNoDelete=False
}
