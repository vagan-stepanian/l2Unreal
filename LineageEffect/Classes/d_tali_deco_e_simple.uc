class d_tali_deco_e_simple extends Emitter;
...
defaultproperties
{
     Begin Object Class=MeshEmitter Name=MeshEmitter7
         ...
         UseColorScale=True
         ColorScale(0)=(Color=(B=242,G=164,A=255))
         ...
         Name="MeshEmitter7"
     End Object
     Emitters(0)=MeshEmitter'LineageEffect.d_tali_deco_e_simple.MeshEmitter7'
     ...
     End Object
     Emitters(1)=SpriteEmitter'LineageEffect.d_tali_deco_e_simple.SpriteEmitter21'
     ...
     End Object
     Emitters(2)=SpriteEmitter'LineageEffect.d_tali_deco_e_simple.SpriteEmitter22'
     ...
     End Object
     Emitters(3)=VertMeshEmitter'LineageEffect.d_tali_deco_e_simple.VertMeshEmitter7'
     ...
     End Object
     Emitters(4)=SpriteEmitter'LineageEffect.d_tali_deco_e_simple.SpriteEmitter23'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter58
         ColorScale(0)=(Color=(B=255,G=255,R=255,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=255,G=128,A=255))
         ColorMultiplierRange=(X=(Min=1.000000,Max=1.000000),Y=(Min=0.750000,Max=0.750000),Z=(Min=0.700000,Max=0.700000))
         Opacity=0.260000
         FadeOutStartTime=0.810000
         FadeOut=True
         FadeInEndTime=0.435000
     ...
     End Object
     Emitters(5)=SpriteEmitter'LineageEffect.d_tali_deco_e_simple.SpriteEmitter58'
     AutoDestroy=False
     bNoDelete=False
}
