class spatk_test_a_simple extends Emitter;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=VertMeshEmitter'LineageEffect.spatk_test_a_simple.VertMeshEmitter1'
     ...
     End Object
     Emitters(1)=SpriteEmitter'LineageEffect.spatk_test_a_simple.SpriteEmitter10'
     bLightChanged=True
     bNoDelete=False
     bSunAffect=True
     DrawScale=0.150000
