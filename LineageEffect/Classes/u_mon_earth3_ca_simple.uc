class u_mon_earth3_ca_simple extends Emitter;
...
defaultproperties
{
     Begin Object Class=MeshEmitter Name=MeshEmitter235
         ...
         RenderTwoSided=True
         UseColorScale=True
         ColorScale(0)=(Color=(B=147,G=92,R=64,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=117,G=147,R=72,A=255))
         ...
         Name="MeshEmitter235"
     End Object
     Emitters(0)=MeshEmitter'LineageEffect.u_mon_earth3_ca_simple.MeshEmitter235'
     Begin Object Class=MeshEmitter Name=MeshEmitter236
         ...
         UseColorScale=True
         ColorScale(0)=(Color=(B=2,G=249,R=236,A=255))
         ColorScale(1)=(RelativeTime=0.353571,Color=(B=170,G=193,R=247,A=255))
         ColorScale(2)=(RelativeTime=0.589286,Color=(G=159,R=255,A=255))
         ColorScale(3)=(RelativeTime=1.000000,Color=(B=1,G=99,R=120,A=255))
         Opacity=0.300000
         ...
         Name="MeshEmitter236"
     End Object
     Emitters(1)=MeshEmitter'LineageEffect.u_mon_earth3_ca_simple.MeshEmitter236'
     Begin Object Class=MeshEmitter Name=MeshEmitter237
         ...
         RenderTwoSided=True
         UseColorScale=True
         ColorScale(0)=(Color=(B=5,G=117,R=177,A=255))
         ColorScale(1)=(RelativeTime=0.478571,Color=(B=13,G=122,R=242,A=255))
         ColorScale(2)=(RelativeTime=1.000000,Color=(B=19,G=185,R=135,A=255))
         ...
         Name="MeshEmitter237"
     End Object
     Emitters(2)=MeshEmitter'LineageEffect.u_mon_earth3_ca_simple.MeshEmitter237'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter345
         ...
         Name="SpriteEmitter345"
     End Object
     Emitters(3)=SpriteEmitter'LineageEffect.u_mon_earth3_ca_simple.SpriteEmitter345'
     bLightChanged=True
     bNoDelete=False
     bSunAffect=True
}
