class d_bluepar02_deco_simple extends Emitter;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'LineageEffect.d_bluepar02_deco_simple.SpriteEmitter46'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter49
         UseDirectionAs=PTDU_Up
         Acceleration=(Z=2.000000)
         UseColorScale=True
         ColorScale(0)=(Color=(B=255,G=255,R=255,A=255))
         ColorScale(1)=(RelativeTime=0.382143,Color=(B=213,G=107,R=57,A=255))
     ...
     End Object
     Emitters(1)=SpriteEmitter'LineageEffect.d_bluepar02_deco_simple.SpriteEmitter49'
     bNoDelete=False
}
