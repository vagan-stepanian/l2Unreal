class d_sacshilen_a_simple extends Emitter;

defaultproperties
{
     Begin Object Class=VertMeshEmitter Name=VertMeshEmitter19
         VertexMesh=VertMesh'BG_EffectMeshes.sacrifice_shilenV01'
         UseMeshBlendMode=False
         RenderTwoSided=False
         ColorScale(0)=(Color=(B=255,G=255,R=255,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=255,G=255,R=255,A=255))
         FadeOutStartTime=138.600006
         FadeOut=True
         MaxParticles=1
         StartLocationOffset=(Z=-10.000000)
         ZWrite=True
         UseRevolution=True
         RevolutionCenterOffsetRange=(Z=(Min=-17.000000,Max=-1.000000))
         ...
         LifetimeRange=(Min=140.000000,Max=140.000000)
         WarmupTicksPerSecond=1.000000
         RelativeWarmupTime=1.000000
         Name="VertMeshEmitter19"
     End Object
     Emitters(0)=VertMeshEmitter'LineageEffect.d_sacshilen_a_simple.VertMeshEmitter19'
     Begin Object Class=MeshEmitter Name=MeshEmitter37
         ...
         Name="MeshEmitter37"
     End Object
     Emitters(1)=MeshEmitter'LineageEffect.d_sacshilen_a_simple.MeshEmitter37'
     ...
     End Object
     Emitters(2)=SpriteEmitter'LineageEffect.d_sacshilen_a_simple.SpriteEmitter237'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter238
         Acceleration=(Z=5.000000)
         UseColorScale=True
         ColorScale(0)=(Color=(B=202,G=202,R=202,A=255))
         ColorScale(1)=(RelativeTime=0.564286,Color=(B=98,G=98,R=98,A=255))
     ...
     End Object
     Emitters(3)=SpriteEmitter'LineageEffect.d_sacshilen_a_simple.SpriteEmitter238'
     bLightChanged=True
     bNoDelete=False
     bSunAffect=True
     Rotation=(Yaw=112)
