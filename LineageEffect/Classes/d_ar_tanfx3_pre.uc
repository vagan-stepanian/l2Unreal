class d_ar_tanfx3_pre extends Emitter;
...
defaultproperties
{
     Begin Object Class=MeshEmitter Name=MeshEmitter16
         ...
         Name="MeshEmitter16"
     End Object
     Emitters(0)=MeshEmitter'LineageEffect.d_ar_tanfx3_pre.MeshEmitter16'
     Begin Object Class=MeshEmitter Name=MeshEmitter24
         ...
         ColorScale(1)=(RelativeTime=0.239286,Color=(B=38,G=73,R=121,A=255))
         ColorScale(2)=(RelativeTime=1.000000,Color=(B=18,G=18,R=44,A=255))
         ...
         Name="MeshEmitter24"
     End Object
     Emitters(1)=MeshEmitter'LineageEffect.d_ar_tanfx3_pre.MeshEmitter24'
     ...
     End Object
     Emitters(2)=SpriteEmitter'LineageEffect.d_ar_tanfx3_pre.SpriteEmitter10'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter14
         ...
         UseColorScale=True
         ColorScale(0)=(Color=(B=255,G=255,R=255,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=60,G=118,R=198,A=255))
         Opacity=0.900000
     ...
     End Object
     Emitters(3)=SpriteEmitter'LineageEffect.d_ar_tanfx3_pre.SpriteEmitter14'
     bRotEmitter=True
     RotPerSecond=(Roll=91440)
     bNoDelete=False
     bSunAffect=True
     Rotation=(Roll=-1605153285)
     DrawScale=0.100000
