class d_mon_deco_g extends Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter60
         ...
         StartSizeRange=(X=(Min=22.025000,Max=22.025000),Y=(Min=22.025000,Max=22.025000),Z=(Min=22.025000,Max=22.025000))
     ...
     End Object
     Emitters(0)=SpriteEmitter'LineageEffect.d_mon_deco_g.SpriteEmitter60'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter61
         ...
         ColorMultiplierRange=(X=(Min=0.700000,Max=0.700000),Y=(Min=0.800000,Max=0.800000),Z=(Min=0.500000,Max=0.500000))
         Opacity=0.500000
     ...
     End Object
     Emitters(1)=SpriteEmitter'LineageEffect.d_mon_deco_g.SpriteEmitter61'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter62
         ...
         ColorScale(6)=(RelativeTime=1.000000,Color=(B=255,G=252,R=244,A=255))
         ColorScale(7)=(RelativeTime=1.000000,Color=(B=232,G=232,R=232,A=255))
         ColorMultiplierRange=(X=(Min=0.400000,Max=0.400000),Y=(Min=0.700000,Max=0.700000),Z=(Min=0.200000,Max=0.200000))
         Opacity=0.300000
     ...
     End Object
     Emitters(2)=SpriteEmitter'LineageEffect.d_mon_deco_g.SpriteEmitter62'
     ...
     End Object
     Emitters(3)=SpriteEmitter'LineageEffect.d_mon_deco_g.SpriteEmitter63'
     bNoDelete=False
}
