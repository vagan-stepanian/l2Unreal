...
//#ifdef __L2 // ttmayrin
var		bool		bRelativeMove;	// if true, update Destination by Relative variable.
var		vector		DestinationRel;	// Relative location being moved toward
var		Actor		RelActor;		// Relative Actor
//#endif
