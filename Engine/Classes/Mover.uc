...
var		int				DamageGrade;
var()	string			MoverName;
var()	bool			bOpen;
var()	staticmesh		MeshGrade[7];
var()	float			RangeHeight;
var()	vector			RangeDelta[4];
var()	vector			HitActorNormal;
var(MoverSounds)	array<sound>	DamageSounds;
var(MoverSounds)	array<sound>	BrokenSounds;
//#endif
...
{
    RangeHeight=150.00
    RangeDelta(0)=(X=-80.00,Y=-80.00,Z=0.00),
    RangeDelta(1)=(X=80.00,Y=-80.00,Z=0.00),
    RangeDelta(2)=(X=80.00,Y=80.00,Z=0.00),
    RangeDelta(3)=(X=-80.00,Y=80.00,Z=0.00),
    MoverEncroachType=1
    MoverGlideType=1
    NumKeys=2
    MoveTime=1.00
