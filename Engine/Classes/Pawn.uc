...
//var localized name TurnAnimName[11];				//회전
//var localized name WalkAnimName[11];				//걷기
//var localized name RunAnimName[11];				//뛰기
//var localized name FallAnimName[11];				//추락
//var localized name DamageFlyAnimName[11];		//데미지점프
//var localized name JumpAnimName[11];				//점프
//var localized name BJumpAnimName[11];			//뒤로점프
//var localized name WaitAnimName[11];				//일반대기
//var localized name AtkWaitAnimName[11];			//공격대기
//var localized name SitAnimName[11];				//서있다가 앉는모션
//var localized name SitWaitAnimName[11];			//바닥에 앉아서 대기중
//var localized name StandAnimName[11];			//앉아 있다가 서는 모션
//var localized name DeathStandAnimName[11];		//누워 있다가 서는 모션
//var localized name ChairSitAnimName[11];			//의자에 앉는 모션
//var localized name ChairWaitAnimName[11];		//의자에 앉아서 대기중
//var localized name ChairStandAnimName[11];		//의자에서 일어남
//var localized name StunAnimName[11];				//스턴, 상태이상
//var localized name Atk01AnimName[11];			//공격1(중)
//var localized name Atk02AnimName[11];			//공격2(중)
//var localized name Atk03AnimName[11];			//공격3(중)
//var localized name AtkUpAnimName[11];			//공격4(상)
//var localized name AtkDownAnimName[11];			//공격5(하)
//var localized name SpAtk01AnimName[11];			//특수공격1
//var localized name SpAtk02AnimName[11];			//특수공격2
//var localized name SpAtk03AnimName[11];			//특수공격3
//var localized name SpAtk04AnimName[11];			//특수공격4
//var localized name SpAtk05AnimName[11];			//특수공격5
//var localized name SpAtk06AnimName[11];			//특수공격6
//var localized name SpAtk07AnimName[11];			//특수공격7
//var localized name SpAtk08AnimName[11];			//특수공격8
//var localized name SpAtk09AnimName[11];			//특수공격9
//var localized name SpAtk10AnimName[11];			//특수공격10
//var localized name SpAtk11AnimName[11];			//특수공격11
//var localized name SpAtk12AnimName[11];			//특수공격12
//var localized name SpAtk13AnimName[11];			//특수공격13
//var localized name SpAtk14AnimName[11];			//특수공격14
//var localized name SpAtk15AnimName[11];			//특수공격15
//var localized name SpAtk16AnimName[11];			//특수공격16
...
//var localized name SpAtk27AnimName[11];			//춤모션
//var localized name SpAtk28AnimName[11];
//var localized name ShieldAtkAnimName[11];		//방패로 치기
//var localized name DefenceAnimName[11];			//방패방어공격
//var localized name DodgeAnimName[11];			//회피하며공격
//var localized name DeathAnimName[11];			//사망해서 눕는 모션
//var localized name DeathWaitAnimName[11];		//누워있는 모션
//var localized name SitDeathAnimName[11];		    //앉아서 죽는모션
//var localized name SitDeathWaitAnimName[11];	    //앉아서 죽어있는 모션
//var localized name DamageAnimName[11];			//데미지
//var localized name CastShortAnimName[11];		//마법주문1 (1초미만)
//var localized name CastMidAnimName[11];			//마법주문2 (2-5초)
//var localized name CastLongAnimName[11];			//마법주문3 (5초이상)
//var localized name CastEndAnimName[11];			//마법정지
//var localized name MagicThrowAnimName[11];		//마법사용1 (던지기)
//var localized name MagicShotAnimName[11];		//마법사용2 (발사)
//var localized name MagicNoTargetAnimName[11];	//마법사용3 (타겟없음)
//var localized name MagicFriendAnimName[11];		//마법사용4 (아군에게)
//var localized name PicItemAnimName[11];			//아이템 줍기
//var localized name ThrowAnimName[11];			//아이템 던지기
//var localized name PcSocialAnimName[20];		//PC소셜 포즈(소셜)
//var localized name NpcSocialAnimName[10];		//NPC소셜 포즈(소셜)
//var localized name RiderWaitAnimName[11];		//용마 대기
//var localized name RiderAtkAnimName[11];			//용마 공격
//var localized name RiderRunAnimName[11];			//용마 뛰기
//var localized name RiderDeathWaitAnimName[11];	//용마 누워있기
//var localized name RiderDeathAnimName[11];		//용마 사망해서 눕기
//var localized name SwimDeathAnimName[11];		//수영중 사망
//var localized name SwimAnimName[11];				//수영 
//var localized name SwimWaitAnimName[11];			//수영 대기
//var localized name SwimDeathWaitAnimName[11];		//수영 사망후 대기
//var localized name SwimAttackWaitAnimName[11];	//수영 공격대기
...
//// by anima - 카마엘 전용으로 추가된 Animataion Sequence
...
//// by ttmayrin - AirShip운전,대포용 Animation Sequence
//var localized name SocialCannonAnimName;		//AirShip 대포잡는 자세
//var localized name SocialOperateAnimName;		//AirShip 키잡는 자세
//var localized name RiseAnimName;			//상승 
//var localized name GlideAnimName;			//활공
//var localized name ShieldWaitAnimName;		//방패 착용시 대기
//
//var localized name SpecialSocial1AnimName;			// GM 변신체가 소셜액션이 필요하다고 해서 스킬로 처리 - lancelot 2010. 5. 12.
...
//
//// 마법캐스팅 A조합부터 L까지 랜덤 발동을 위해 추가 애니메이션 7개.  Array를 더 이상 추가하면 컴파일이 안되서 이런 방식을 했음. lancelot 2009. 10. 19.
...
//var localized float WalkAnimRate[11];			//걷기
//var localized float RunAnimRate[11];				//뛰기 
//var localized float Atk01AnimRate[11];			//공격1(중)
//var localized float Atk02AnimRate[11];			//공격2(중)
//var localized float Atk03AnimRate[11];			//공격3(중)
//var localized float AtkUpAnimRate[11];			//공격4(상)
//var localized float AtkDownAnimRate[11];			//공격5(하)
//var localized float SpAtk01AnimRate[11];			//특수공격1
//var localized float SpAtk02AnimRate[11];			//특수공격2
//var localized float SpAtk03AnimRate[11];			//특수공격3
//var localized float SpAtk04AnimRate[11];			//특수공격4
//var localized float ShieldAtkAnimRate[11];		//방패로 치기
//var localized float CastShortAnimRate[11];		//마법주문1 (1초미만)
//var localized float CastMidAnimRate[11];			//마법주문2 (2-5초)
//var localized float CastLongAnimRate[11];		//마법주문3 (5초이상)
//var localized float CastShortEndAnimRate[11];	//마법정지
//var localized float MagicThrowAnimRate[11];		//마법사용1 (던지기)
//var localized float MagicShotAnimRate[11];		//마법사용2 (발사)
//var localized float MagicNoTargetAnimRate[11];	//마법사용3 (타겟없음)
//var localized float MagicFriendAnimRate[11];		//마법사용4 (아군에게)
//var localized float ThrowAnimRate[11];			//아이템 던지기
